...
$html[] = '<h2>DefaultDictionaryBindDaoImplTest</h2>';

$html[] = '<h3>queryAll</h3>';
$html[] = echoPre($defaultDictionaryBindDaoImpl->queryAll());

$html[] = '<h3>queryBySetId($setId = 1)</h3>';
$html[] = echoPre($defaultDictionaryBindDaoImpl->queryBySetId('1'));

$html[] = '<h3>queryByBindId($setId = 1, $bindId = 1)</h3>';
$html[] = echoPre($defaultDictionaryBindDaoImpl->queryByBindId('1', '1'));
?>