...
$html[] = '<h2>TranslationExecDaoImplTest</h2>';

$html[] = '<h3>queryAll()</h3>';
$html[] = echoPre($translationExecDaoImpl->queryAll());

$html[] = '<h3>queryByPathId($pathId = 3)</h3>';
$translationExecObj = $translationExecDaoImpl->queryByPathId('3');
$html[] = echoPre($translationExecObj);

$html[] = '<h3>getTranslationBinds($translationExecObj)</h3>';
$html[] = echoPre($translationExecDaoImpl->getTranslationBinds($translationExecObj[0]));
?>