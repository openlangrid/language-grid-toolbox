...
$html[] = '<h2>DefaultDictionarySettingDaoImplTest</h2>';

$html[] = '<h3>queryAll</h3>';
$html[] = echoPre($defaultDictionarySettingDaoImpl->queryAll());

$html[] = '<h3>queryBySetId($setId = 1)</h3>';
$html[] = echoPre($defaultDictionarySettingDaoImpl->queryBySetId('1'));
?>