...
$html[] = '<h2>TranslationBindDaoImplTest</h2>';

$html[] = '<h3>queryAll()</h3>';
$html[] = echoPre($translationBindDaoImpl->queryAll());

$html[] = '<h3>queryByExecObject($transltionExecObj)</h3>';
$transltionExecObj = $translationExecDaoImpl->queryByPathId('3');
$html[] = echoPre($translationBindDaoImpl->queryByExecObject($transltionExecObj[0]));
