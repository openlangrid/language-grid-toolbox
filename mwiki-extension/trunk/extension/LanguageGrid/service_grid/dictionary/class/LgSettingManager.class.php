...
class LgSettingManager {
	...
	private static $jsBase = array(
		'main' => array(
			...
			'${JS_PATH}/include/include-dictionary-manager.js',
			'${JS_PATH}/include/include-dictionary-pane.js',
			'${JS_PATH}/include/include-dictionary-workspace.js',
			'${JS_PATH}/include/include-dictionary-main.js',
			'${JS_PATH}/load/load-dictionary-manager.js',
			'${JS_PATH}/load/load-dictionary-pane.js',
			'${JS_PATH}/load/load-dictionary-workspace.js',
			'${JS_PATH}/load/load-dictionary-main.js',
			'${JS_PATH}/upload/upload-dictionary-pane.js',
			'${JS_PATH}/upload/upload-dictionary-workspace.js',
			'${JS_PATH}/upload/upload-dictionary-main.js',
