...
//	protected $serviceGridDefaultDictionaryDaoImpl = 'DefaultDictionaryDaoImpl';
	...
	protected $serviceGridTranslationOptionDaoImpl = 'TranslationOptionDaoImpl';
	// DAO実装クラスへのパス
	...
	public function getTranslationOptionDao() {
		require_once(dirname(__FILE__).$this->serviceGridDaoPath.$this->serviceGridTranslationOptionDaoImpl.'.class.php');
		return new $this->serviceGridTranslationOptionDaoImpl($this->getDataBase());
	}
