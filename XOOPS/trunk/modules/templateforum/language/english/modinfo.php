...
if( defined( 'FOR_XOOPS_LANG_CHECKER' ) || ! defined( $constpref.'_LOADED' ) ) {
	...
	//2010916 add
	define($constpref.'_NOTIFY_LIMIT', 'Max length of message in post notification');
	//20120822 add
	define($constpref.'_BBS_TEMPLATE', 'Template item setting');
}
