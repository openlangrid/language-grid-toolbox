...
define('_MD_ALBM_HOW_TO_USE_LINK', 'apfilesharing_en.html');
...
// Use is Dialog
define('_MI_apfilesharingDIALOG_DIALOG_TITLE', 'Select a file');
define('_MI_apfilesharingDIALOG_UPLOAD_BUTTON', 'Upload a file');
define('_MI_apfilesharingDIALOG_TABLE_COL_SELECT', '');
define('_MI_apfilesharingDIALOG_TABLE_COL_NAME', 'File name');
define('_MI_apfilesharingDIALOG_TABLE_COL_DESC', 'Description');
define('_MI_apfilesharingDIALOG_TABLE_COL_READ', 'Read');
define('_MI_apfilesharingDIALOG_TABLE_COL_EDIT', 'Edit');
define('_MI_apfilesharingDIALOG_TABLE_COL_UPDATER', 'Created by');
define('_MI_apfilesharingDIALOG_TABLE_COL_UPDATE', 'Last update');
define('_MI_apfilesharingDIALOG_OK_BUTTON', 'OK');
define('_MI_apfilesharingDIALOG_CANCEL_BUTTON', 'Cancel');
define('_MI_apfilesharingDIALOG_SAVE_DIALOG_TITLE', 'Save a file');
define('_MI_apfilesharingDIALOG_SAVE_FILE_NAME', 'File name');
define('_MI_apfilesharingDIALOG_SAVE_FILE_DESC', 'Description');
define('_MI_apfilesharingDIALOG_SAVE_PERM', 'Permission');
define('_MI_apfilesharingDIALOG_SAVE_READ_PERM', 'Read permission');
define('_MI_apfilesharingDIALOG_SAVE_EDIT_PERM', 'Edit permission');
define('_MI_apfilesharingDIALOG_SAVE_PERM_OPT_PUBLIC', 'For all users');
define('_MI_apfilesharingDIALOG_SAVE_PERM_OPT_USER', 'For the current user only');
define('_MI_apfilesharingDIALOG_SAVE_OK_BUTTON', 'Save');
define('_MI_apfilesharingDIALOG_ROOT_FOLDER_LABEL', 'Top');
define('_MI_apfilesharingDIALOG_ERROR_PERMISSION_NO_EDIT', 'You have no permission to save in this folder.');
...
define( 'MD_apfilesharing_ALL_USER','ALL USER');
define( 'MD_apfilesharing_UP_USER','OWNER');

define( 'MD_FSA_SUBMIT_DIALOG_RP','Permission of reading isn\'t established. Only an owner of a file can read.');
define( 'MD_FSA_SUBMIT_DIALOG_EP','Permission of edit isn\'t established. Only an owner of a file can edit.');
define( 'MD_FSA_SUBMIT_DIALOG','Is it sent?');

define('MD_FSA_NOT_PARENT_FOLDER_PERMISSION_FOLDER', 'It can\'t be established because a right of this folder isn\'t permitted by a parent folder.');
define('MD_FSA_NOT_PARENT_FOLDER_PERMISSION_FILE', 'It can\'t be established because a right of this file isn\'t permitted by a parent folder.');
define('MD_FSA_NOT_CHILDREN_FOLDER_PERMISSION', 'It can\'t be established because a right of a child element isn\'t permitted.');
}
