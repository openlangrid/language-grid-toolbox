 ...
 * Common
 */
define('_MD_D3FORUM_BBS_TOP', 'BBS 위쪽');
define('_MD_D3FORUM_BBS', 'BBS');
define('_MD_D3FORUM_BBS_SEARCH', 'Search');
define('_MD_D3FORUM_FORUM', '포럼');
define('_MD_D3FORUM_CATEGORY', '범주');
define('_MD_D3FORUM_DESCRIPTION', '설명');
define('_MD_D3FORUM_TOTALFORUMSCOUNT', '포럼');
define('_MD_D3FORUM_LASTPOST', '마지막 게시');
define('_MD_D3FORUM_TOPICTITLE', '항목 제목');
define('_MD_D3FORUM_ON', '게시됨');
define('_MD_D3FORUM_NOW_TRANSLATING', '번역하는 중 ...');
define('_MD_D3FORUM_DOPOST', '게시');
define('_MD_D3FORUM_OK', '확인');
define('_MD_D3FORUM_COMMON_CANCEL', '취소');
define('_MD_D3FORUM_COMMON_CREATE', '생성');
define('_MD_D3FORUM_COMMON_MODIFY', '사후 편집');
define('_MD_D3FORUM_COMMON_REPLY', '회신');
define('_MD_D3FORUM_COMMON_EDIT', '사전 편집');
define('_MD_D3FORUM_COMMON_DELETE', '삭제');
define('_MD_D3FORUM_COMMON_OK', '확인');
define('_MD_D3FORUM_COMMON_ORIGINAL_MESSAGE', '원래 메시지');
define('_MD_D3FORUM_COMMON_ORIGINAL_TITLE', '원래 제목');
define('_MD_D3FORUM_POSTASNEWTOPIC', '새 항목 생성');
define('_MD_D3FORUM_POST_MODIFICATION_HISTORIES', '수정 기록');
define('_MD_D3FORUM_CANCEL', '취소');
define('_MD_D3FORUM_POSTED_ON', '게시한 날짜: %s');
define('_MD_D3FORUM_MODIFIED_ON', '수정한 날짜: %s');
define('_MD_D3FORUM_EDITED_ON', '편집한 날짜: %s');
//20090919 add
define('_MD_D3FORUM_COMMON_TRANSLATE', '번역');
define('_MD_D3FORUM_COMMON_TRANSLATION', '번역');
define('_MD_D3FORUM_COMMON_BACK_TRANSLATION', '역번역');
define('_MD_D3FORUM_COMMON_NOW_TRANSLATING', '변역하는 중 …');
define('_MI_D3FORUM_HOW_TO_USE_LINK', 'bbs_ko.html');
define('_MD_D3FORUM_PREVIEW_NO_SOURCE', '%s이(가) 비어 있습니다..');
define('_MD_D3FORUM_PREVIEW_NO_TRANSLATOIN_RESULT', 'Translation result of {1} (Language: {0}) is empty.');
define('_MD_D3FORUM_COMMON_COMMIT', '커밋');
define('_MD_D3FORUM_COMMON_POST', '게시');
//20090928 add
define('_MD_D3FORUM_TRANSLATION_LANGRID_ERROR', 'Language Grid에서 오류가 발생했습니다.');
define('_MD_D3FORUM_MODIFY_ERROR_MESSAGE_IS_EMPTY', '%s이(가) 비어 있습니다..');
//20091013 add
define('_MD_D3FORUM_COMMON_LICENSE_INFORMATION', '라이센스 정보');
define('_MD_D3FORUM_COMMON_SERVICE_NAME', '서비스 이름');
define('_MD_D3FORUM_COMMON_COPYRIGHT', '저작권');
//20091113 add
define('_MD_D3FORUM_COMMON_PULL_REFRESH', '새로 고침');
define('_MD_D3FORUM_COMMON_PULL_AUTO_UPDATE', '자동');
define('_MD_D3FORUM_COMMON_PULL_MANUAL_UPDATE', '수동');
//20091124 add
define('_MD_D3FORUM_COMMON_NEW_POST', '게시');
define('_MD_D3FORUM_CONFIRM_DELETE', '선택한 파일을 삭제하시겠습니까?');
define('_MD_D3FORUM_CAPTION_UPLOAD', '첨부한 파일');
define('_MD_D3FORUM_ATACCHED_FILELIST', '첨부한 파일 목록');
define('_MD_D3FORUM_FILE_NOT_EXIST', '지정한 파일이 없거나 파일 크기가 0바이트입니다. 지정한 파일이 없거나 파일 크기가 0바이트입니다.');
define('_MD_D3FORUM_CAPTION_FILESIZE', '크기(KB)');
define('_MD_D3FORUM_CAPTION_FILENAME', '이름');
define('_MD_D3FORUM_DELETE_FILE', '삭제');
define('_MD_D3FORUM_CAPTION_CLOSE', '닫기');
define('_MD_D3FORUM_FILE_OVER_LIMIT_COUNT', '최대 {0}개 파일까지 첨부할 수 있습니다.');
//20091126 add
define('_MD_D3FORUM_FILE_OVER_LIMIT', '첨부한 파일의 최대 크기가 {0}KB입니다.');
//20091215 add
define('_MD_D3FORUM_BTN_SEARCH', 'Search');
define('_MD_D3FORUM_MSG_NOMATCH', 'No matching result.');
//20100205 add
define('_MD_COPYRIGHT_LB', 'Copyright (C) 2009-2010 Department of Social Informatics, Kyoto University. All rights reserved.');

// comment integration
define('_MD_D3FORUM_POSTASCOMMENTTOP', '새 메시지 게시');

// module top (done)
define('_MD_D3FORUM_TOTALTOPICSCOUNT', '항목');
define('_MD_D3FORUM_TOTALPOSTSCOUNT', '메시지');

// postform (done)
define('_MD_D3FORUM_POSTREPLY', '회신');
define('_MD_D3FORUM_POSTEDIT', '사전 편집');
define('_MD_D3FORUM_POSTDELETE', '삭제');
define('_MD_D3FORUM_ERR_NOMESSAGE', '비어 있는 메시지를 게시했습니다.');

// makeforum and forummanager
define('_MD_D3FORUM_TH_FORUMTITLE', '포럼 제목');
define('_MD_D3FORUM_TH_FORUMDESC', '포럼 설명');

// makecategory and categorymanager
define('_MD_D3FORUM_TH_CATEGORYTITLE', '범주 제목');
define('_MD_D3FORUM_TH_CATEGORYDESC', '범주 설명');

// add
define('_MD_D3FORUM_POST_TRANSLATION_MODIFY', '사후 편집');
define('_MD_D3FORUM_CREATE_TOPIC', '새 항목 생성');
define('_MD_D3FORUM_POST_TRANSLATE', '번역');
define('_MD_D3FORUM_POST_TRANSLATION_RESULT', '번역 결과');
define('_MD_D3FORUM_POST_BACK_TRANSLATION_RESULT', '역번역 결과');
define('_MD_D3FORUM_PREVIEW', '미리 보기');
define('_MD_D3FORUM_MODIFY_MODE', '모드 사전 편집');
define('_MD_D3FORUM_ERR_NOT_EXIST_MENU', '액세스할 수 있는 범주나 포럼이 없습니다.');
define('_MD_D3FORUM_RETURN_PAGE_TOP', '맨 위로 이동');
define('_MD_D3FORUM_RETURN_COMMUNITY_TOP', 'BBS 위쪽');
define('_MD_D3FORUM_ORIGINAL_TEXT', '원래 텍스트');
define('_MD_D3FORUM_TRANSLATION_RESULT', '번역');
define('_MD_D3FORUM_BACK_TRANSLATION_RESULT', '역번역');
define('_MD_D3FORUM_FROM', '시작');
define('_MD_D3FORUM_TO', '끝');
define('_MD_D3FORUM_POST_DELETED', '이 게시물은 삭제되었습니다.');
define('_MD_D3FORUM_CATEGORY_DELETE', '이 범주 삭제');
define('_MD_D3FORUM_FORUM_DELETE', '이 포럼 삭제');

/**
 * Modify Mode
 */
define('_MD_D3FORUM_MODIFY_COMMON_ORIGINAL_INFORMATION', '원래 정보');
define('_MD_D3FORUM_MODIFY_COMMON_ORIGINAL_MESSAGE', '원래 메시지');
define('_MD_D3FORUM_MODIFY_COMMON_TRANSLATION', '번역');
define('_MD_D3FORUM_NO_TRANSLATION', '번역할 수 없습니다.');
define('_MD_D3FORUM_POST_ORIGINAL_TEXT', '원래 메시지');
define('_MD_D3FORUM_POST_MODIFY_TEXT', '번역 결과');
define('_MD_D3FORUM_EDIT_TOPIC', '사전 편집');
define('_MD_D3FORUM_MODIFY_TOPIC', '사후 편집');
define('_MD_D3FORUM_DELETE_TOPIC', '삭제');
define('_MD_D3FORUM_MESSAGE', '메시지');
define('_MD_D3FORUM_CREATE', '생성');
define('_MD_D3FORUM_EDIT', '사전 편집');
define('_MD_D3FORUM_MODIFY', '사후 편집');
define('_MD_D3FORUM_DELETE', '삭제');
define('_MD_D3FORUM_CREATE_A_NEW_CATEGORY', '새 범주 생성');
define('_MD_D3FORUM_CREATE_A_NEW_FORUM', '새 포럼 생성');
define('_MD_D3FORUM_CREATE_A_NEW_TOPIC', '새 항목 생성');
define('_MD_D3FORUM_MODIFY_OK', '확인');
define('_MD_D3FORUM_DELETE_CONFIRM_CATEGORY', '범주를 삭제하시겠습니까?');
define('_MD_D3FORUM_DELETE_CONFIRM_FORUM', '포럼을 삭제하시겠습니까?');
define('_MD_D3FORUM_DELETE_CONFIRM_TOPIC', '항목을 삭제하시겠습니까?');
define('_MD_D3FORUM_DELETE_CONFIRM_MESSAGE', '메시지를 삭제하시겠습니까?');
define('_MD_D3FORUM_CATEGORY_MODIFY_TITLE', '사후 편집');
define('_MD_D3FORUM_REPLY', '회신');

define('_MD_D3FORUM_BTN_POSTED_NOTICE', 'Preferences');
define('_MD_D3FORUM_POSTED_NOTICE_POP_TITE', 'Preferences');
define('_MD_D3FORUM_POSTED_NOTICE_POP_LB_INTERVAL', 'Post notification');
define('_MD_D3FORUM_POSTED_NOTICE_POP_LB_LANGUAGE', 'Language');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_0', 'None');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_1', 'For each post');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_2', 'Once a day');

define('_MD_D3FORUM_JUMPBOX_BUTTON', '投稿');
define('_MD_D3FORUM_JUMPBOX_NEW_OPTION_CAT', '(New)');
define('_MD_D3FORUM_JUMPBOX_NEW_OPTION_FORUM', '(New)');
define('_MD_D3FORUM_JUMPBOX_NEW_OPTION_TOPIC', '(New)');

define('_MD_D3FORUM_TAG_MANAGE_TITLE', 'Message tag');
define('_MD_D3FORUM_ADD_TAG_SET', 'Add');
define('_MD_D3FORUM_BLANK', '---');
define('_MD_D3FORUM_CONFIRM_DISCARD_CHANGES', 'Discard changes?');
define('_MD_D3FORUM_CONFIRM_DELETE', 'Are you sure to delete?');
define('_MD_D3FORUM_CONFIRM_DELETE_BOUND_WORD_SET', 'This word set is used by #{0} translation template(s). Are you sure you want to delete this word set?');
define('_MD_D3FORUM_ALL_EMPTY_NOT_REGISTER', 'You must enter at least one item.');
define('_MD_D3FORUM_EDIT_TAGS', 'Edit message tag');
define('_MD_D3FORUM_ADD_TAG', 'Add');
define('_MD_D3FORUM_CLOSE', 'Close');
define('_MD_D3FORUM_TAG_CONFIG_POP_SAVE', 'Save');
define('_MD_D3FORUM_TAG_CONFIG_POP_EDIT', 'Edit');
define('_MD_D3FORUM_TAG_CONFIG_POP_DELETE', 'Delete');
define('_MD_D3FORUM_TAG_CONFIG_POP_CANCEL', 'Cancel');
define('_MD_D3FORUM_JUMPBOX_ALL_OPTION_CAT', '(All)');
define('_MD_D3FORUM_JUMPBOX_ALL_OPTION_FORUM', '(All)');
define('_MD_D3FORUM_JUMPBOX_ALL_OPTION_TOPIC', '(All)');
define('_MD_D3FORUM_SEARCH_SCOPE', 'Scope');
define('_MD_D3FORUM_SEARCH_KEYWORD', 'Keyword');
define('_MD_D3FORUM_SEARCH_TAG', 'Tag');
