...
SearchInput.prototype = {
	...
	onSubmitButton_Clicked : function(event) {
		...
		url += this.getQueryByStartDate();
		url += this.getQueryByEndDate();
	...
	getQueryByStartDate : function() {
		if ($F(this._ID_.startDate)) {
			return '&startDate='+$F(this._ID_.startDate);
		} else {
			return '';
		}
	},

	getQueryByEndDate : function() {
		if ($F(this._ID_.endDate)) {
			return '&endDate='+$F(this._ID_.endDate);
		} else {
			return '';
		}
	},
