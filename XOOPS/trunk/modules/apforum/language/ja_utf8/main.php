 ...
 * Common
 */
define('_MD_D3FORUM_BBS_TOP', '掲示板トップ');
define('_MD_D3FORUM_BBS', '掲示板');
define('_MD_D3FORUM_BBS_SEARCH', '検索');
...
define('_MI_D3FORUM_HOW_TO_USE_LINK', 'bbs_ja.html');
...
//20091113 add
define('_MD_D3FORUM_COMMON_PULL_REFRESH', '更新');
define('_MD_D3FORUM_COMMON_PULL_AUTO_UPDATE', '自動');
define('_MD_D3FORUM_COMMON_PULL_MANUAL_UPDATE', '手動');
//20091124 add
define('_MD_D3FORUM_COMMON_NEW_POST', '新規投稿');
define('_MD_D3FORUM_CONFIRM_DELETE', '本当に削除してもよろしいですか？');
define('_MD_D3FORUM_CAPTION_UPLOAD', '添付ファイル');
define('_MD_D3FORUM_ATACCHED_FILELIST', '添付ファイルリスト');
define('_MD_D3FORUM_FILE_NOT_EXIST', '指定したファイルが見つからないか、またはファイルサイズが0バイトです。');
define('_MD_D3FORUM_CAPTION_FILESIZE', 'サイズ (KB)');
define('_MD_D3FORUM_CAPTION_FILENAME', '名前');
define('_MD_D3FORUM_DELETE_FILE', '削除');
define('_MD_D3FORUM_CAPTION_CLOSE', '閉じる');
define('_MD_D3FORUM_FILE_OVER_LIMIT_COUNT', '添付ファイルは{0}個までです。');
//20091126 add
define('_MD_D3FORUM_FILE_OVER_LIMIT', '添付できるファイルサイズの上限は{0}KBです。');
//20091215 add
define('_MD_D3FORUM_BTN_SEARCH', '検索');
...
//20101022 add
define('_MD_D3FORUM_FIRSTPOST','最初の投稿');
...
// 20110907 add
define('_MD_D3FORUM_TH_AUTH', 'アクセス権限');
define('_MD_D3FORUM_PREVIEW_NO_CHECK_AUTH', 'アクセス権限：所属グループが選択されていません。');
define('_MD_D3FORUM_PREVIEW_NO_CHECK_CHILD_AUTH', 'アクセス権限：子要素のアクセス権限が許可されていません');
define('_MD_D3FORUM_PREVIEW_NO_CHECK_PARENT_AUTH', '親要素で許可されていないアクセス権限が選択されています');
define('_MD_D3FORUM_PREVIEW_CHECKBOX_NO_CHECK', 'アクセス権限：少なくとも一つのグループを選択してください');
define('_MD_D3FORUM_PREVIEW_INPUT_ERROR','入力エラー');
define('_MD_D3FORUM_PREVIEW_ALL_GROUPS','全てのグループ');
define('_MD_D3FORUM_PREVIEW_CAN_NOT_ALL_GROUPS',"全てのグループは選択できません。");
// add
...
define('_MD_D3FORUM_RETURN_COMMUNITY_TOP', '掲示板トップ');
...
define('_MD_D3FORUM_BTN_POSTED_NOTICE', '設定');
define('_MD_D3FORUM_POSTED_NOTICE_POP_TITE', '設定');
define('_MD_D3FORUM_POSTED_NOTICE_POP_LB_INTERVAL', '投稿の通知');
define('_MD_D3FORUM_POSTED_NOTICE_POP_LB_LANGUAGE', '表示言語');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_0', '通知しない');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_1', '投稿ごとに通知');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_2', '一日に一回通知');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_3', '投稿ごとに通知(返信のみ)');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_4', '一日に一回通知(返信のみ)');

define('_MD_D3FORUM_JUMPBOX_BUTTON', '投稿');
define('_MD_D3FORUM_JUMPBOX_NEW_OPTION_CAT', '(新規作成)');
define('_MD_D3FORUM_JUMPBOX_NEW_OPTION_FORUM', '(新規作成)');
define('_MD_D3FORUM_JUMPBOX_NEW_OPTION_TOPIC', '(新規作成)');

define('_MD_D3FORUM_TAG_MANAGE_TITLE', 'メッセージタグ');
define('_MD_D3FORUM_ADD_TAG_SET', '追加');
define('_MD_D3FORUM_BLANK', '---');
define('_MD_D3FORUM_CONFIRM_DISCARD_CHANGES', '変更を破棄しますか？');
define('_MD_D3FORUM_CONFIRM_DELETE', '本当に削除してもよろしいですか？');
define('_MD_D3FORUM_CONFIRM_DELETE_BOUND_WORD_SET', 'この単語集合は#{0}件の穴あき用例対訳で使用されています。本当に削除しますか？');
define('_MD_D3FORUM_ALL_EMPTY_NOT_REGISTER', 'すべての項目が空欄では登録できません。');
define('_MD_D3FORUM_EDIT_TAGS', 'メッセージタグの編集');
define('_MD_D3FORUM_ADD_TAG', '追加');
define('_MD_D3FORUM_CLOSE', '閉じる');
define('_MD_D3FORUM_TAG_CONFIG_POP_SAVE', '保存');
define('_MD_D3FORUM_TAG_CONFIG_POP_EDIT', '編集');
define('_MD_D3FORUM_TAG_CONFIG_POP_DELETE', '削除');
define('_MD_D3FORUM_TAG_CONFIG_POP_CANCEL', 'キャンセル');
define('_MD_D3FORUM_JUMPBOX_ALL_OPTION_CAT', '(全て)');
define('_MD_D3FORUM_JUMPBOX_ALL_OPTION_FORUM', '(全て)');
define('_MD_D3FORUM_JUMPBOX_ALL_OPTION_TOPIC', '(全て)');
define('_MD_D3FORUM_SEARCH_SCOPE', '検索対象');
define('_MD_D3FORUM_SEARCH_KEYWORD', 'キーワード');
define('_MD_D3FORUM_SEARCH_TAG', 'タグ');
define('_MD_D3FORUM_SEARCH_DATE', '検索日付');
define('_MD_D3FORUM_RECENTLY_POST_SEARCH', '最近の書込み');
define('_MD_D3FORUM_RECENTLY_POST_SEARCH_OPTION', '日付を指定');

/* Protocalendar Resource */
define('_MD_D3FORUM_PROTOCALENDAR_HOUR_MINUTE_ERROR', '不正な時間です。');
define('_MD_D3FORUM_PROTOCALENDAR_NO_DATE_ERROR', '日付が選択されていません');
define('_MD_D3FORUM_PROTOCALENDAR_DEFAULT_FORMAT', 'yyyy/mm/dd');  # supported format: http://www.php.net/manual/ja/datetime.formats.date.php
define('_MD_D3FORUM_PHP_DATE_DEFAULT_FORMAT', 'Y/m/d'); # FIXME:
define('_MD_D3FORUM_PROTOCALENDAR_LABEL_FORMAT', 'yyyy/mm/dd ddd');
define('_MD_D3FORUM_PROTOCALENDAR_OK_LABEL', 'OK');
define('_MD_D3FORUM_PROTOCALENDAR_JAN', '1月');
define('_MD_D3FORUM_PROTOCALENDAR_FEB', '2月');
define('_MD_D3FORUM_PROTOCALENDAR_MAR', '3月');
define('_MD_D3FORUM_PROTOCALENDAR_APR', '4月');
define('_MD_D3FORUM_PROTOCALENDAR_MAY', '5月');
define('_MD_D3FORUM_PROTOCALENDAR_JUN', '6月');
define('_MD_D3FORUM_PROTOCALENDAR_JUL', '7月');
define('_MD_D3FORUM_PROTOCALENDAR_AUG', '8月');
define('_MD_D3FORUM_PROTOCALENDAR_SEP', '9月');
define('_MD_D3FORUM_PROTOCALENDAR_OCT', '10月');
define('_MD_D3FORUM_PROTOCALENDAR_NOV', '11月');
define('_MD_D3FORUM_PROTOCALENDAR_DEC', '12月');
