...
class User_EditUserForm extends User_AbstractUserEditForm 
{
	...
	function prepare()
	{
		...
		$this->mFieldProperties['uorder']->setDependsByArray(array('intRange'));
		...
		$this->mFieldProperties['notify_method']->setDependsByArray(array('intRange'));
		...
		$this->mFieldProperties['notify_mode']->setDependsByArray(array('intRange'));
