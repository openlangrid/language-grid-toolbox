...
Object.extend(LanguageSelectorsPanel.prototype, {
	...
	init : function(minSelectLanguages) {
		this.MIN_SELECT_LANGUAGES = minSelectLanguages;
...
//		this.initEventListeners();
	...
	getArrayedLanguages : function() {
		...
		this.selectedLanguages.each(function(selectedLanguage, i) {
			...
			languages.push(selectedLanguage.code);
		}.bind(this));
		return languages;
	},
