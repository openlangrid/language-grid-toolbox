...
require_once APP_ROOT_PATH.'/class/workspace/WorkspaceXmlReader.class.php';

class ReadWorkspaceAction extends AjaxAction {
	...
	public function execute() {
		...
		try {
			...
			$reader = new WorkspaceXmlReader($contents);
			$workspace = $reader->read();

			$this->buildSuccessResult($workspace);
		} catch (Exception $e) {
