...
define($constpref.'_MODULE_NAME', '[en]Discussion[/en][ja]ディスカッション[/ja]');
// A brief description of this module
define($constpref.'_MODULE_DESCRIPTION', 'This is a module of multilingual communication');
	//20091126 add
	...
	//20100106 add
	define($constpref.'_MESSAGE_FILE_CAT_ID', 'File sharing folder id');
}
...
// 20100113 add
define('COM_INTERVAL_OF_AUTOMATIC_MESSAGE_UPDATE', 'Interval of automatic message update (sec.)');
define('COM_CONTENT_FILE_CATEGORY_ID', 'Content file sharing categor id');
define('COM_DESCRIPTION_AN_TIME', 'Enter the period by seconds.');
define('COM_DESCRIPTION_AN_CATEGORY_ID', 'Enter the category id by number.');
?>