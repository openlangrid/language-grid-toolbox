...
/* 20130131 add */
define('_MD_D3FORUM_ORGACCESS', 'アクセス状況_組織別');
define('_MD_D3FORUM_USERACCESS', 'アクセス状況_ユーザ別');

define('_MD_D3FORUM_ORGNAME', '組織');
define('_MD_D3FORUM_USERNAME', 'ユーザ');
/* 20130131 add */

/* 20130225 add */
define('_MD_D3FORUM_AD_LBL_SOURCELANGUAGE', '原文言語');
define('_MD_D3FORUM_AD_LBL_TARGETLANGUAGE', '翻訳言語');
define('_MD_D3FORUM_AD_LBL_DICTIONARYNAME', '辞書');
define('_MD_D3FORUM_AD_LBL_ADDWORDBTN', '単語追加');
define('_MD_D3FORUM_AD_LBL_ADDWORDOPEN', '辞書登録');
define('_MD_D3FORUM_AD_LBL_SUCCESSTOADDWORD', '登録成功 ');
/* 20130225 add */
