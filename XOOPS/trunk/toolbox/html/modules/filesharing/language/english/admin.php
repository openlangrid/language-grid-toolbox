...
//mod 091228
define( "_AM_CAT_LINK_MAKETOPCAT" , "Create a new category" ) ;
define( "_AM_CAT_TH_FILES" , "Files" ) ;
...
define( "_AM_CAT_LINK_ADDFILES" , "Add a image into this category" ) ;
define( "_AM_CAT_LINK_EDIT" , "Edit this category" ) ;
define( "_AM_CAT_LINK_MAKESUBCAT" , "Create a new category under this category" ) ;
define( "_AM_CAT_FMT_NEEDADMISSION" , "%s files are needed to be admitted" ) ;
...
// File Manager
define( "_AM_H3_FMT_FILEMANAGER" , "File Manager (%s)" ) ;
define( "_AM_TH_BATCHUPDATE" , "Update checked files collectively" ) ;
...
define( "_AM_MB_FILESTABLE" , "Files table" ) ;
...
define( "_AM_MB_NUMBEROFFILES" , "Number of Files" ) ;
...
define( "_AM_MB_DIRECTORYFORFILES" , "Directory for Files" ) ;
...
define( "_AM_ERR_SAMEDIR" , "Error: Files Path should not be the same as Thumbs Path" ) ;
...
define( "_AM_H4_FILELINK" , "Files & Thumbs Link Check" ) ;
define( "_AM_MB_NOWCHECKING" , "Now, checking ." ) ;
define( "_AM_FMT_FILENOTREADABLE" , "a main file (%s) is not readable." ) ;
define( "_AM_FMT_THUMBNOTREADABLE" , "a thumbnail (%s) is not readable." ) ;
define( "_AM_FMT_NUMBEROFDEADFILES" , "%s dead file files have been found." ) ;
...
// Redo Thumbnail
define( "_AM_H3_FMT_RECORDMAINTENANCE" , "myAlbum-P file maintenance (%s)" ) ;

define( "_AM_FMT_CHECKING" , "checking %s ..." ) ;

define( "_AM_FORM_RECORDMAINTENANCE" , "maintenance of files like remaking thumbnails etc." ) ;
...
define( "_AM_MB_FILENOTEXISTS" , "main file does not exist." ) ;
define( "_AM_MB_FILERESIZED" , "main file was resized." ) ;
...
define( "_AM_RADIO_REMOVEREC" , "remove records that don't link to a main file" ) ;
define( "_AM_RADIO_RESIZE" , "resize bigger files than the pixels specified in current preferences" ) ;
...
// GroupPerm Global
define( "_AM_MD_ALBM_GROUPPERM_GLOBAL" , "Global Permissions" ) ;
define( "_AM_MD_ALBM_GROUPPERM_GLOBALDESC" , "Configure group's priviledges for this module" ) ;
define( "_AM_MD_ALBM_GPERMUPDATED" , "Permissions have been changed successfully" ) ;


// Import
define( "_AM_H3_FMT_IMPORTTO" , 'Importing images from another module to %s' ) ;
define( "_AM_FMT_IMPORTFROMFSHAREP" , 'Importing from "%s" as module type of myAlbum-P' ) ;
...
define( "_AM_FMT_IMPORTSUCCESS" , 'You have imported %s files' ) ;
...
define( "_AM_FMT_EXPORTSUCCESS" , 'You have exported %s files' ) ;
