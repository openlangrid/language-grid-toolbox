...
if( ! empty( $_POST['submit'] ) ) {
	...
	$xoopsOption['template_main'] = "filesharing_ratefile.html" ;
	...
	$xoopsTpl->assign( 'file' , filesharing_get_array_for_file_assign( $fetched_result_array ) ) ;
