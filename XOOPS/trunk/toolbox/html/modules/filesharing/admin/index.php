...
redirect_header(XOOPS_MODULE_URL . "/legacy/admin/index.php?action=PreferenceEdit&confmod_id=$filesharing_mid", 1, "Sorry. GO TO Preference!!");
...
if( $action == "insert" ) {
	...
	foreach( $children as $child ) {
		$whr .= "$child," ;
		xoops_notification_deletebyitem( $filesharing_mid , 'category' , $child ) ;
	}
	$whr .= "$cid)" ;
	xoops_notification_deletebyitem( $filesharing_mid , 'category' , $cid ) ;
