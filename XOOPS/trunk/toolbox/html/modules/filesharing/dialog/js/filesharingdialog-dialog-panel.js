...
//  ------------------------------------------------------------------------ //
/* $Id: filesharingdialog-dialog-panel.js 4583 2010-10-13 09:53:46Z yoshimura $ */

var FileSharingDialogDialogPanel = Class.create();
Object.extend(FileSharingDialogDialogPanel.prototype, DialogPanel.prototype);
Object.extend(FileSharingDialogDialogPanel.prototype, {

	idPrefix: 'filesharingdialog_dialog_',
...
//		FileSharingDialogState.Condition.addObserver(this.footPanel);
		return this.element;
	},
