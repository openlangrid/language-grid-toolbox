...
define($constpref.'_NAME', '[en]Showroom(BBS)[/en][ja]ショールーム(BBS)[/ja]');
// A brief description of this module
define($constpref.'_DESC', 'This is a module of multilingual BBS where messages can be displayed in multiple languages.');
//20091126 add
define($constpref.'_MESSAGE_TIME_MANUAL', 'Interval of update checking in manual update (sec.)');
define($constpref.'_MESSAGE_TIME_AUTO', 'Interval of automatic update (sec.)');
define($constpref.'_MESSAGE_TIME_MAX', 'Data retention time of current topic readers (sec.)');
define($constpref.'_FILE_LIMIT_NUMBER', 'Maximum number of attached files');
define($constpref.'_FILE_LIMIT_SIZE', 'Maximum size of an attached file');
define($constpref.'_DESCRIPTION_AN_HOUR', 'Enter the period by seconds.');
define($constpref.'_DESC_LIMIT_SIZE', 'Enter the size by KB.');
define($constpref.'_MESSAGE_ACCESSLOG_MAXTIME', 'Maximum retention time of messages');
//20100106 add
define($constpref.'_MESSAGE_FILE_CAT_ID', 'File sharing categor id');
//20100203 add
define($constpref.'_GUEST_ID', 'User ID for a guest');
define($constpref.'_GUEST_PASSWORD', 'Password for a guest');
define($constpref.'_MSG_NO_MODULE', 'The module you entered was not found.');
define($constpref.'_MSG_EMPTY_MODULE', 'The module name must not be empty.');
define($constpref.'_MSG_IMPORT_DATA', 'Import contents');
define($constpref.'_MSG_IMPORT_DATA_SUCCESS', 'You have successfully imported the contents.');
define($constpref.'_MSG_IMPORT_BUTTON', 'Import');
}
