...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return d3forum_oninstall_base2( $module , "'.$mydirname.'" ) ; } ' ) ;

if( ! function_exists( 'd3forum_oninstall_base2' ) ) {

function d3forum_oninstall_base2( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'd3forum_message_append_oninstall2' ) ;
		$ret = array() ;
	} else {
...
function d3forum_message_append_oninstall2( &$module_obj , &$log )
{
