...
//		$this->languageManager = D3LanguageManager::getInstance();
	...
	public function categoryEdit() {
		...
		$sql .= ' cat_id = %d AND uid = %d AND delete_flag = 0';
//		$this->db->prepare($sql);
...
//		$result = $this->db->execute();
	...
	public function categoryDelete() {
		...
		$sql .= ' WHERE (uid = %d) AND cat_id = %d AND delete_flag = 0 ';
...
//		$result = $this->db->execute();
	...
	public function forumDelete() {
		...
		$sql .= ' WHERE (uid = %d) AND forum_id = %d AND delete_flag = 0 ';
...
//		}
	...
	public function isGuest() {
		return $this->root->mContext->mXoopsUser->get('uname') == $this->root->mContext->mModuleConfig['guest_user_id'];
	}
