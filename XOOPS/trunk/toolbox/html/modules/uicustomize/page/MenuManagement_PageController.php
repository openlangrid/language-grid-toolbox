...
//  ------------------------------------------------------------------------ //
/* $Id: MenuManagement_PageController.php 3662 2010-06-16 02:22:17Z yoshimura $ */

require_once(dirname(__FILE__).'/AbstractPageController.php');

class MenuManagement_PageController extends AbstractPageController {

	protected $mConfig = array(
		'pageType' => 'menu',
		'template' => 'db:uicustomize-menumanage-main.html',
