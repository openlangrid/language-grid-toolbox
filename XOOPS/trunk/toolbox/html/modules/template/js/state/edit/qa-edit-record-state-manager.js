...
//		this.record = {};
		...
		this.record.parameterIds = this.currentRecord.parameterIds.clone();
...
//		this.currentRecord = {};
		...
		this.currentRecord.parameterIds = this.record.parameterIds.clone();
...
//		this.restoreAnswers();
	...
	serialized : function() {
		...
		this.currentRecord.parameterIds.each(function(id, i){
			parameters['parameterIds[' + i + ']'] = id;
		});
