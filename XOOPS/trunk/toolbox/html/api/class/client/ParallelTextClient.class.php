...
//  ------------------------------------------------------------------------ //
require_once(dirname(__FILE__).'/../../IParallelTextClient.interface.php');
require_once(dirname(__FILE__).'/Toolbox_AbstractClient.class.php');
require_once(dirname(__FILE__).'/../manager/Toolbox_Resource_ParallelTextCreateEditManager.class.php');
require_once(dirname(__FILE__).'/../manager/Toolbox_Resource_ParallelTextReadManager.class.php');
require_once(dirname(__FILE__).'/ResourceClient.class.php');

/**
 * ParallelTextClient
 */
class ParallelTextClient extends Toolbox_AbstractClient implements IParallelTextClient {
	...
	public function getAllRecords($name, $offset = null, $limit = null) {
		$manager = new Toolbox_Resource_ParallelTextReadManager();
	...
	public function setRecords($name, $records) {
		$manager = new Toolbox_Resource_ParallelTextCreateEditManager();
