...
class BBS_CategoryAccessObject extends XoopsSimpleObject {

	function BBS_CategoryAccessObject() {
		...
		$this->initVar('can_makeforum', XOBJ_DTYPE_INT, 0, false);
		$this->initVar('is_moderator', XOBJ_DTYPE_INT, 0, false);
	}
}

class BBS_CategoryAccessHandler extends XoopsObjectGenericHandler {

	var $mTable = "";
	var $mPrimary = "cat_id";
	var $mClass = "BBS_CategoryAccessObject";
	
	public function __construct(&$db,$moduleName) {
		parent::__construct($db);
		$this->mTable = $db->prefix($moduleName."_category_access");
	}
