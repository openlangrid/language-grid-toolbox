...
class FileSharing_FolderObject extends XoopsSimpleObject {
	function FileSharing_FolderObject() {
...
class FileSharing_FolderHandler extends XoopsObjectGenericHandler {
	var $mTable = "filesharing_folder";
	var $mPrimary = "cid";
	var $mClass = "FileSharing_FolderObject";
}
?>