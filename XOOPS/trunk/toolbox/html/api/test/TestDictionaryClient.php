...
require_once(dirname(__FILE__).'/../class/client/DictionaryClient.class.php');
...
//$e1en->expression = '1ST';
//
//$rec1 = new ToolboxVO_Dictionary_DictionaryRecord();
//$rec1->id = 1;
...
//$e2en->expression = '2ND';
//
//$rec2 = new ToolboxVO_Dictionary_DictionaryRecord();
//$rec2->id = 2;
//$rec2->expressions = array($e2ja, $e2en);
//
//print_r($client->setRecords('ENJA', array($rec1, $rec2)));
//echo '</pre>';
...
//
//print_r($client->addRecord('ENJA', array($e1ja, $e1en)));
//echo '</pre>';
//
//
//echo '<h2>deleteRecord()</h2>';
//echo '<pre>';
//print_r($client->deleteRecord('ENJA', 2));
//echo '</pre>';
...
//
//print_r($client->updateRecord('ENJA', 4, array($e1ja, $e1en)));
//echo '</pre>';


echo '<h2>getAllRecords()</h2>';
echo '<pre>';
print_r($client->getAllRecords('ENJA'));
echo '</pre>';

echo '<h2>searchRecord()</h2>';
echo '<pre>';
print_r($client->searchRecord('ENJA', '追加', 'ja', 'prefix'));
echo '</pre>';
