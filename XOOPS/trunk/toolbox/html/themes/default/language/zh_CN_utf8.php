...
//Used by Toolbox
define('_THEME_TOP_UNAME_LB', '用户ID');
define('_THEME_TOP_PASSWD_LB', '密码');
define('_THEME_TOP_LOGIN_LB', '登录');
define('_THEME_TOP_LOGOUT_LB', '退出');
define('_THEME_TOP_NEW_USER_LB', '注册');
define('_MD_USER_LANG_LOSTPASS', '忘记密码？');

//user.php
define('_US_LOGGINGU', '欢迎，%s');
//20100205 add
define('_US_LOGGIN_GUEST', '');
//20090919 add
define('_THEME_MENU_TEXT00_LB', '顶部');
define('_THEME_MENU_TEXT01_LB', 'BBS');
define('_THEME_MENU_TEXT02_LB', '翻译');
define('_THEME_MENU_TEXT03_LB', '新建');
define('_THEME_MENU_TEXT04_LB', '用户资料');
define('_THEME_MENU_TEXT05_LB', '服务设定');
define('_THEME_HOW_TO_USE', '使用说明');
//20091013 add
define('_THEME_MENU_COMMUNICATION', '通信');
define('_THEME_MENU_TEXT_TRANSLATION', '文本翻译');
define('_THEME_MENU_SPEECH_TRANSLATION', 'Speech translation');
//20091014 add
define('_THEME_MENU_SETTING', '设定');
//20091020 add
define('_THEME_MENU_IMPORTED_SERVICES', '服务导入                  ');
//20091022 add
define('_THEME_MENU_SETTING_BBS', 'BBS');
define('_THEME_MENU_SETTING_TEXT_TRANSLATION', '文本翻译');
define('_THEME_MENU_TEXT_DICTIONARY', '词典');
define('_THEME_MENU_TEXT_PARALLEL_TEXT', '双语对照文本');
//20091112 add
define('_THEME_MENU_WEB_TRANSLATION', '网页');
define('_THEME_MENU_SETTING_WEB_TRANSLATION', '网页');
//20091130 add
define('_THEME_SIGNIN_MESSAGE', '初次访问Toolbox?请点击此按钮。');
//20091215 add
define('_THEME_MENU_COMMUNITY', '社区');
define('_THEME_MENU_USER_SEARCH', '用户列表');
define('_THEME_MENU_TEXT_FILE_MANAGEMENT', '文件共享');
//20100107 add
...
//pagetitle
define('_THEME_PAGETITLE_USERINFO', '用户资料');
