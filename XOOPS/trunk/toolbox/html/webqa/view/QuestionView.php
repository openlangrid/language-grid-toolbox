...
class QuestionView extends AbstractView {
	...
	function dispatch(&$context) {
		...
		$categoryList = $qaManager->getCategory();
		// $forum_exist = $qaManager->getBBSForumConfig_exist();

		$smarty->assign('categoryList', $categoryList);
		// $smarty->assign('forum_exist', $forum_exist);
		...
		if ($context->get('error_message_list') != null) {
