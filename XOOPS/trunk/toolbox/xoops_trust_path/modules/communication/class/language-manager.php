...
class LanguageManager {
	...
	public function __construct() {
		...
		if (isset($_COOKIE["selectedLanguage"])
			...
			if (array_search('en', $this->allLanguages)) {
...
//			}
		...
		setcookie('selectedLanguage', $this->selectedLanguage, time()+60*60*24*30, XOOPS_COOKIE_PATH.'/modules/communication');
...
//			}
	...
	public function getNameByTag($tag) {
		...
		if (isset($LANGRID_LANGUAGE_ARRAY[$tag])) {
			return $LANGRID_LANGUAGE_ARRAY[$tag];
		} else {
			return $tag;
		}
	}
