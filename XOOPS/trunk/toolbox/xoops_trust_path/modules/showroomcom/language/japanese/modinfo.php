...
define($constpref.'_NOTCAT_GLOBAL', 't���ƥ��꡼');
define($constpref.'_NOTCAT_GLOBALDSC', 't���ƥ��꡼���̤����Υ��ץ����');
...
define($constpref.'_NOTIFY_GLOBAL_NEWPOSTCAP', 't���ƥ��꡼�Τ����줫����Ƥ����ä��������Τ���');
define($constpref.'_NOTIFY_GLOBAL_NEWPOSTSBJ', '[{X_SITENAME}] {X_MODULE}: ��� {POST_TITLE}');

define($constpref.'_NOTIFY_GLOBAL_NEWTOPIC', '���ȥԥå�t��');
define($constpref.'_NOTIFY_GLOBAL_NEWTOPICCAP', 't���ƥ��꡼�Τ����줫�˿����ȥԥå���Ω�Ƥ�줿�������Τ���');
...
define($constpref.'_NOTIFY_GLOBAL_NEWFORUMCAP', 't���ƥ��꡼�Τ����줫�˿��ե�����बΩ�Ƥ�줿�������Τ���');
...
define($constpref.'_NOTIFY_GLOBAL_NEWPOSTFULLCAP', '���tʸ�����Τ��ޤ������оݤ�t���ƥ��꡼��');
