...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return storefront_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'storefront_oninstall_base' ) ) {

function storefront_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'storefront_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function storefront_message_append_oninstall( &$module_obj , &$log )
{
