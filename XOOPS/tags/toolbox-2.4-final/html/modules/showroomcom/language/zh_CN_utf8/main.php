...
define('COM_BACK_SELECTED_CONTENT', '返回所选内容');
define('COM_ALL_TRANSLATION', '');
define('COM_AUTO', '自动');
define('COM_BTN_A_MINUS', 'A-');
define('COM_BTN_A_PLUS', 'A+');
define('COM_BTN_CANCEL', '取消');
define('COM_BTN_NEW_MESSAGE', '新的短消息');
define('COM_BTN_POST', '发表');
define('COM_BTN_REPLY', '回复');
define('COM_BTN_TRANSLATE', '翻译');
define('COM_COMMIT', '提交');
define('COM_IS_REQUIRED', '为必填项');
define('COM_LANGUAGES', '完成');
define('COM_LNK_CLOSE', '关闭');
define('COM_LNK_DELETE', '删除');
define('COM_LNK_EDIT', '原文编辑');
define('COM_LNK_EDIT_TRANSLATION', '译文编辑');
define('COM_LNK_NEW_MESSAGE_ARRIVED', '您有新的短消息（点击载入）');
define('COM_LNK_NEW_MESSAGE_RELOADING', '正在载入新的短消息');
define('COM_LNK_OPEN', '打开');
define('COM_MANUAL', '手动');
define('COM_MESSAGE', '请在此处输入短消息内容。');
define('COM_MESSAGES', '%s条短消息');
define('COM_NEW_MESSAGE', '新的短消息');
define('COM_NOW_TRANSLATIONING', '正在翻译');
define('COM_NOW_TRANSLATION_REMAIN', '正在翻译：');
define('COM_REQUIRED', '为必填项');
define('COM_SUBMITTED_BY_POST_BUTTON', '按下“%s”按钮提交。');
define('COM_SELECT_ATTACHEMENT_CONTENT', '请选择内容');
define('COM_UNSELECT', '清除');
define('COM_BTN_ZOOM', '缩放');
define('COM_CONTENTS', '%s内容');
define('CON_BTN_NEW_CONTENT', '新内容');
define('COM_BTN_CONTENT_DELETE', '删除');
define('COM_BTN_SET_MARKER', '设定标记');
define('COM_BTN_DEL_MARKER', '删除标记');
define('COM_CONTENT_TITLE', '内容标题');
define('COM_SELECT_UPLOAD_FILE', '文件(JPG、PNG、或 GIF 图像文件)');
define('COM_BTN_UPLOAD', '上传');
define('COM_SET_CONTENT_RELATED', '将此内容链接至短消息');
define('COM_CONFIRM_DEL_MARKER', '标记未保存。是否放弃标记？');
define('COM_CONTENT_GUIDELINE', '从以上下拉菜单中选择将链接至短消息的内容。');
define('COM_CONTENT_DEL_REMAIN', '您确定删除所选内容吗？');
define('COM_TRANSLATE_SENTENCE', '翻译结果');
define('COM_REPLY_TO_MESSAGE', '回复短消息 #%s');
define('COM_REQUIRE_URL', '输入Google地图链接的URL。');
define('COM_REQUIRE_SELECT_UPLOAD_FILE', '选择要上传的文件。');
define('COM_DELETE_MESSAGE_CONFIRM', '您确定删除该帖吗？');
define('COM_REPLY_MESSAGES', '回复短消息');
define('COM_REQUIRE_GOOGLE_MAP_URL', '输入Google地图链接的URL。');
define('COM_ENTER_MESSAGE', '');
define('COM_ENTER_GOOGLEMAP_URL', '输入Google地图链接的URL。');
