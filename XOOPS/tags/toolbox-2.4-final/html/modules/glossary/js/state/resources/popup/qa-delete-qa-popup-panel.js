 ...
 * @author kitajima
 */
var QaDeleteQaPopupPanel = Class.create();
Object.extend(QaDeleteQaPopupPanel.prototype, LightPopupPanel.prototype);
Object.extend(QaDeleteQaPopupPanel.prototype, {
	...
	getBody : function() {
		return 	new Template(this.Templates.base).evaluate({
			title : Global.Text.DELETE_LANGUAGE_RESOURCE,
...
QaDeleteQaPopupPanel.prototype.Config = {
	Id : {
...
QaDeleteQaPopupPanel.prototype.Event = {
...
QaDeleteQaPopupPanel.prototype.Templates = {
