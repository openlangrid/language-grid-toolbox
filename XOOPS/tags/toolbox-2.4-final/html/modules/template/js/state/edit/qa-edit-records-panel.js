...
//		});
	...
	createHeaderRowHtml : function() {
		return new Template(this.Templates.headerRow).evaluate({
			...
			parameter : Global.Text.PARAMETER
		});
	},
...
QaEditRecordsPanel.prototype.Templates = {
	headerRow : '<thead><tr><td>in #{source}</td><td class="qa-edit-records-target-language-column">in #{target}</td><td class="qa-edit-records-categories-column">#{category}</td><td class="qa-edit-records-parameters-column">#{parameter}</td><td class="qa-edit-records-delete-column"> </td></tr></thead>'
