...
$allow_actions = array(
	"_index", "create_from_url", "_new", "_show", "_zoom", "image", "delete", "_create_from_server", "_list"
);


$delegator = get_delegator($allow_actions, "_new");


if (@$_GET['action'] == "image") {
	$delegator -> executeStreamRespone();	
} else {
	$delegator -> execute();
}
