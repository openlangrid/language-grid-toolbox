...
//  ------------------------------------------------------------------------ //
/* $Id: TopPageEdit_PageController.php 3662 2010-06-16 02:22:17Z yoshimura $ */

require_once(dirname(__FILE__).'/AbstractPageController.php');

class TopPageEdit_PageController extends AbstractPageController {

	protected $mConfig = array(
		'pageType' => 'toppage',
		'template' => 'db:uicustomize-topmanage-main.html',
