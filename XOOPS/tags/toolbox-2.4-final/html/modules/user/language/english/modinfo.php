...
define('_MI_USER_CONF_BAD_EMAILS', "String patterns that should be allowed as an email address of a user");
//20091224 add
define('_MI_USER_LANG_USER_SUB_PROFILE', "Profile management");
define('_MI_USER_LANG_YES', "Yes");
define('_MI_USER_LANG_NO', "No");
define('_MI_USER_LANG_ERROR_NOT_INPUT_TITLE', "Enter the name of an additional item when you show the item.");
define('_MI_USER_LANG_SUB_TITLE_MESSAGE', "The item name will be displayed up to 30 characters.");
//20100210 add
define('_MI_USER_LANG_SUB_DISPLAY', "Show Addtional Item {0}?");
define('_MI_USER_LANG_SUB_TITLE', "Name of Addtional Item {0}");
define('_MI_USER_LANG_SUB_LENGTH', "Max length of Addtional Item {0}");
define('_MI_USER_LANG_SUB_DEFAULT', "Default value of Addtional Item {0}");
...
define('_MI_USER_CONF_GROUP_ID', "Group ID");
