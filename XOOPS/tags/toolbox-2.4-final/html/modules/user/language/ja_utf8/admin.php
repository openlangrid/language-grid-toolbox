...
define('_AD_USER_LANG_GROUP_NAME', "グループID");
define('_AD_USER_LANG_GROUP_DESC', "説明");
define('_AD_USER_LANG_GROUP_TYPE', "タイプ");
define('_AD_USER_LANG_GROUP_AMMO', "メンバー数");
define('_AD_USER_LANG_GROUP_LG_USER', '言語グリッドID');
define('_AD_USER_LANG_GROUP_LG_PASSWD', '言語グリッドパスワード');
define('_AD_USER_LANG_GROUP_TYPE_DESC', "タイプ");
define('_AD_USER_LANG_GROUP_LGUSER_DESC', "言語グリッドID");
define('_AD_USER_LANG_GROUP_LGPASSWD_DESC', "言語グリッドパスワード");
