...
Event.observe(window, 'load', function(){
	...
	var mainFrame = new ImportedServicesPanel({
		...
		addServicePopupPanel : new AddServicePopupPanel({
			...
			basicUseridId : 'langrid-imported-services-light-popup-basic-userid-input-area',
			basicPasswdId : 'langrid-imported-services-light-popup-basic-passwd-input-area',
