		...
		PopupPanel : {
			...
			addService : {
				...
				body : '<tr><th><h2>#{serviceName}*</h2></th><td><input type="text" value="" id="#{serviceNameId}" /></td></tr>'
						...
						+ '<tr><th><h2>#{basicUserid}</h2></th><td><input id="#{basicUseridId}" type="text" value="" /></td></tr>'
						+ '<tr><th><h2>#{basicPasswd}</h2></th><td><input id="#{basicPasswdId}" type="password" value="" /></td></tr>'
			...
			editService : {
				...
				body : '<tr><th><h2>#{serviceName}</h2></th><td>#{serviceNameValue}</td></tr>'
						...
						+ '<tr><th><h2>#{basicUserid}</h2></th><td><input id="#{basicUseridId}" type="text" value="#{basicUseridValue}" /></td></tr>'
						+ '<tr><th><h2>#{basicPasswd}</h2></th><td><input id="#{basicPasswdId}" type="password" value="#{basicPasswdValue}" /></td></tr>'
