...
class ServerControlShared_IndexAction extends IndexAction {

	protected function getResource() {
		$resource = parent::getResource();

		$resource['url'] = array(
			'loadSetting' => './?page=server_control_shared&action=LoadSetting',
			'saveSetting' => './?page=server_control_shared&action=SaveSetting',
			'saveDictionary' => './?page=server_control_shared&action=SaveDictionary',
