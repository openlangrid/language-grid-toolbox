...
$DIC_TYPE = 0;
try{
	$bd = new BillingualDictionaryService($id, $DIC_TYPE);
	unset($bd);
	...
	$targetNamespace = XOOPS_URL . '/modules/dictionary/services/billingualdictionary/' . urlencode($dId);
	$endpointUrl = XOOPS_URL . '/modules/dictionary/services/invoker/billingualdictionary.php?serviceId='
	 					. urlencode($dId);
	$temp = $template;
