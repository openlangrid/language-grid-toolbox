...
class IndexAction extends AbstractAction {
	...
	private function getResource() {
		...
		$resource['Url'] = array(
			'DOWNLOAD_HTML' => './?action=downloadHtml',
			'LOAD_HTML_BY_FILE' => './?action=loadHtmlByFile',
			'LOAD_HTML_BY_URL' => './?action=loadHtmlByUrl',
			'LOAD_TEMPLATE' => './?action=loadTemplate',
			'LOAD_WORKSPACE' => './?action=loadWorkspace',
			'READ_HTML_BY_FILE' => './?action=readHtmlByFile',
			'READ_TEMPLATE' => './?action=readTemplate',
			'READ_WORKSPACE' => './?action=readWorkspace',
			'SAVE_CACHE' => './?action=saveCache',
			'SAVE_HTML' => './?action=saveHtml',
			'SAVE_TEMPLATE' => './?action=saveTemplate',
