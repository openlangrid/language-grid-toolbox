...
//  ------------------------------------------------------------------------ //
/* $Id: filesharingdialog-foot-panel.js 4583 2010-10-13 09:53:46Z yoshimura $ */

var FileSharingDialogFootPanel = Class.create();
Object.extend(FileSharingDialogFootPanel.prototype, FootPanel.prototype);
Object.extend(FileSharingDialogFootPanel.prototype, {
...
var FileSharingDialogFoot_SavePanel = Class.create();
Object.extend(FileSharingDialogFoot_SavePanel.prototype, FileSharingDialogFootPanel.prototype);
Object.extend(FileSharingDialogFoot_SavePanel.prototype, {

	initialize: function(options, obserbles) {
		FileSharingDialogFootPanel.prototype.initialize.apply(this, arguments);
	},
	...
	onOk: function(event) {
		...
		if (!FileSharingDialogFrame.getCurrentFolder().canEdit) {
			FileSharingDialogFrame.setError(FileSharingDialog_Global.Msg.PermissionErrorNoEdit);
			return;
		}

		// okデリゲートに渡す引数オブジェクトを生成
		var param = {
			folderId : FileSharingDialogFrame.getCurrentFolder().id,
		...
		FileSharingDialogFrame.setState('currentFile', param);
...
FileSharingDialogFoot_SavePanel.prototype.Templates = {
	base : ''
