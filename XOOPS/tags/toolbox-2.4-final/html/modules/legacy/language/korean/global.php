...
//Used by Toolbox
define('_TOKEN_ERROR', '경고 ! 잘못된 형식의 요청이나 게시물을 인스턴트화하지 못하게 됩니다. 확인을 위해 다시 전송하십시오.');

//%%%%%% File Name mainfile.php  %%%%%
define('_NESTED', '중첩됨');
define('_FLAT', '기본');
define('_THREADED', '스레드');
define('_OLDESTFIRST', '오래된 것 먼저');
define('_NEWESTFIRST', '최신 것 먼저');
...
//%%%%%  Common Phrases  %%%%%
// Module info
define('_USERNAME', '사용자 이름: ');
define('_PASSWORD', '암호: ');
define('_LOGIN', '사용자 로그인');
define('_SEND', '보내기');
