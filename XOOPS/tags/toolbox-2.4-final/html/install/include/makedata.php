...
function make_data(&$dbm, &$cm, $adminname, $adminpass, $adminmail, $language, $gruops){
    ...
    $dbm->insert('config', " VALUES (11, 0, 1, 'session_expire', '_MD_AM_SESSEXPIRE', '30', '_MD_AM_SESSEXPIREDSC', 'textbox', 'int', 22)");
    ...
    $dbm->insert("group_permission", " VALUES (0, ".$gruops['XOOPS_GROUP_USERS'].", 3, 1, 'module_read')");
