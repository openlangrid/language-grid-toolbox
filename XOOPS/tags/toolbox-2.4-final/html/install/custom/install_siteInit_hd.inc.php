<?php
  ...
  include_once dirname(dirname(dirname(__FILE__))).'/class/smarty/Smarty.class.php';
  ...
  $default_checked = array('default', 'chic_black', 'skel_flex');
...
//					  $results[] =& $theme;
  ...
  $hd_smarty->assign('default', 'default');
