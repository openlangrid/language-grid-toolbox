...
//Used by Toolbox
define('_THEME_TOP_UNAME_LB', '사용자 ID');
define('_THEME_TOP_PASSWD_LB', '암호');
define('_THEME_TOP_LOGIN_LB', '로그인');
define('_THEME_TOP_LOGOUT_LB', '로그아웃');
define('_THEME_TOP_NEW_USER_LB', '등록');
define('_MD_USER_LANG_LOSTPASS', '암호를 잊으셨습니까?');

//user.php
define('_US_LOGGINGU', '안녕하세요, %s님!');
//20100205 add
define('_US_LOGGIN_GUEST', '');
//20090919 add
define('_THEME_MENU_TEXT00_LB', '맨 위');
define('_THEME_MENU_TEXT01_LB', 'BBS');
define('_THEME_MENU_TEXT02_LB', '번역');
define('_THEME_MENU_TEXT03_LB', '생성');
define('_THEME_MENU_TEXT04_LB', '프로필');
define('_THEME_MENU_TEXT05_LB', '서비스 설정');
define('_THEME_HOW_TO_USE', '사용 방법');
//20091013 add
define('_THEME_MENU_COMMUNICATION', '통신');
define('_THEME_MENU_TEXT_TRANSLATION', '텍스트 번역');
define('_THEME_MENU_SPEECH_TRANSLATION', 'Speech translation');
//20091014 add
define('_THEME_MENU_SETTING', '설정');
//20091020 add
define('_THEME_MENU_IMPORTED_SERVICES', '서비스 가져오기');
//20091022 add
define('_THEME_MENU_SETTING_BBS', 'BBS');
define('_THEME_MENU_SETTING_TEXT_TRANSLATION', '텍스트 번역');
define('_THEME_MENU_TEXT_DICTIONARY', '사전');
define('_THEME_MENU_TEXT_PARALLEL_TEXT', '가로 텍스트');
//20091112 add
define('_THEME_MENU_WEB_TRANSLATION', '웹');
define('_THEME_MENU_SETTING_WEB_TRANSLATION', '웹');
//20091130 add
define('_THEME_SIGNIN_MESSAGE', 'Toolbox를 처음 사용하십니까? 이 버튼을 클릭하십시오.');
//20091215 add
define('_THEME_MENU_COMMUNITY', '커뮤니티');
define('_THEME_MENU_USER_SEARCH', '사용자 목록');
define('_THEME_MENU_TEXT_FILE_MANAGEMENT', '파일 공유');
//20100107 add
...
//20100319 add
define('_THEME_MENU_AUTOCOMPLETE_SETTING', 'ParallelText');

//pagetitle
define('_THEME_PAGETITLE_USERINFO', '프로필');
