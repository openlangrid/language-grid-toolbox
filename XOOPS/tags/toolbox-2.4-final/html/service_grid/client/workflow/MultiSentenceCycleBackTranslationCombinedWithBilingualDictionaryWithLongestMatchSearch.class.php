 ...
 *
 */
class MultiSentenceCycleBackTranslationCombinedWithBilingualDictionaryWithLongestMatchSearch 
    ...
    function _translate() {
    	debugLog('MultiSentenceCycleBackTranslationCombinedWithBilingualDictionaryWithLongestMatchSearch invoke!');
