 ...
 *
 * @package Legacy
 * @version $Id: Legacy_TextFilter.class.php,v 1.1 2008/03/09 02:32:38 xoopserver Exp $
...
class Legacy_TextFilter extends XCube_TextFilter
{
    ...
    function makeClickableConvertTable(&$patterns, &$replacements) {
        ...
        $replacements[] = "\\1<a href=\"\\2://\\3\" target=\"_blank\" rel=\"nofollow\">\\2://\\3</a>";
        $patterns[] = "/(^|[^]_a-z0-9-=\"'\/])www\.([a-z0-9\-]+)\.([^, \r\n\"\(\)'<>]+)/i";
        $replacements[] = "\\1<a href=\"http://www.\\2.\\3\" target=\"_blank\" rel=\"nofollow\">www.\\2.\\3</a>";
        $patterns[] = "/(^|[^]_a-z0-9-=\"'\/])ftp\.([a-z0-9\-]+)\.([^, \r\n\"\(\)'<>]+)/i";
        $replacements[] = "\\1<a href=\"ftp://ftp.\\2.\\3\" target=\"_blank\" rel=\"nofollow\">ftp.\\2.\\3</a>";
