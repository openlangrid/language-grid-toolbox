...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return task_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'task_oninstall_base' ) ) {

function task_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'task_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function task_message_append_oninstall( &$module_obj , &$log )
{
