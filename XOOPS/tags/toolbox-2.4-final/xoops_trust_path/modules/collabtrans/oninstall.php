...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return collaborative_translation_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'collaborative_translation_oninstall_base' ) ) {

function collaborative_translation_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'collaborative_translation_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
	...
	if( file_exists( $sql_file_path ) ) {
		...
		// insert the predefined translation_set and paths
	    require_once dirname(__FILE__).'/include/translation_path_set.php';
	    if(! insertTranslationSet()) {
	    	return false;
	    }
	}
...
function collaborative_translation_message_append_oninstall( &$module_obj , &$log )
{
