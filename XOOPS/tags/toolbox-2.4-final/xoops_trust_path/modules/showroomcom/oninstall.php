...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return communication_oninstall_base2( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'communication_oninstall_base2' ) ) {

function communication_oninstall_base2( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'communication_message_append_oninstall2' ) ;
		$ret = array() ;
	} else {
...
function communication_message_append_oninstall2( &$module_obj , &$log )
{
