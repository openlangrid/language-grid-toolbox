...
class Folder extends AbstractFile {
	...
	public function getOwner() {
		return $this -> fileObject -> owner;
	}
	
	public function getReadPermissionType() {
		return $this -> fileObject -> readPermission -> type;
	}
	
	public function getReadPermissionUserId() {
		return $this -> fileObject -> readPermission -> userId;
	}
	
	public function getEditPermissionType() {
		return $this -> fileObject -> editPermission -> type;
	}
	
	public function getEditPermissionUserId() {
		return $this -> fileObject -> editPermission -> userId;
	}
	...
	public function getParentFolder() {
		...
		$response = $client -> getFolder($this -> getParentId());
		if($response['contents']) {
			$fd =  new Folder($response['contents']);
			return $fd;
		}
	}
