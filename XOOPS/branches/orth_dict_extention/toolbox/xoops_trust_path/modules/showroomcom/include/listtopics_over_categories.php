...
while( $topic_row = $db->fetchArray( $trs ) ) {
	...
	$topicTitle = $myts->makeTboxData4Show( $topic_row['topic_title'] , $topic_row['fp_number_entity'] , $topic_row['fp_special_entity'] ) ;
	
	if (strlen($topicTitle) > 51) {
		$shortTitle = substr($topicTitle, 0, 50).'...';
	}
