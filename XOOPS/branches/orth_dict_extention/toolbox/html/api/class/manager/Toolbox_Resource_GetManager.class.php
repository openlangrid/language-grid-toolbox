...
// Copyright (C) 2009-2013  NICT Language Grid Project
//
...
class Toolbox_Resource_GetManager extends Toolbox_Resource_AbstractManager {
	...
	public function getAllResources($type = null, $offset = null, $limit = null) {
		...
		switch (strtoupper($type)) {
			...
			case 'TRANSLATION_TEMPLATE';
				...
				break;
			case 'NORMALIZED_DICTIONARY';
				$objects = $this->getNormalizedDictionarys($offset, $limit);
				break;
			default:
	...
	protected function getNormalizedDictionarys($offset = null, $limit = null) {
		return $this->get('6',null,$offset,$limit);
	}
	...
	public function search($word, $matchingMethod, $type, $languages = array(), $offset = null, $limit = null) {
		...
		switch (strtoupper($type)) {
			...
			case 'TRANSLATION_TEMPLATE';
				...
				break;
			case 'NORMALIZED_DICTIONARY';
				$mCriteria->add(new Criteria('type_id', 6));
				break;
			default:
				break;
		}
