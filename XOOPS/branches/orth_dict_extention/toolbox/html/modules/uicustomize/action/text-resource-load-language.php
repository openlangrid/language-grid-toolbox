...
//  ------------------------------------------------------------------------ //
/**
 * $Id: text-resource-load-language.php 3662 2010-06-16 02:22:17Z yoshimura $
 */
error_reporting(0);
...
try {
//	$result['contents']['languages'] = array('en', 'ja', 'ko');
	$c = new CubeUtil_Hack();
	$result['contents']['languages'] = $c->getUISupportLanguages();
} catch (Exception $e) {
	$result['status'] = 'ERROR';
