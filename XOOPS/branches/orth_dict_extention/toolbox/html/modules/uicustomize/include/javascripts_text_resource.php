...
//	'/component/util/language-utils.js',
	...
	// Text-Resource
	'/state/text-resource/text-resources-state.js',
	'/state/text-resource/text-resources-panel.js',
	'/state/text-resource/text-resources-header-panel.js',
	'/state/text-resource/text-resources-body-panel.js',
	'/state/text-resource/text-resources-body-panel-table-sorter.js',

	// *popup
	'/state/text-resource/popup/text-edit-language-popup-panel.js',
	'/state/text-resource/popup/context-menu-popup-panel.js',
//	'/state/text-resource/popup/file-list-popup-panel.js',
