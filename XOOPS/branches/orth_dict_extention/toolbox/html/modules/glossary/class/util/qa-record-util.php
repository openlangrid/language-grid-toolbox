...
class QaRecordUtil {
	...
	/**
	 * 
	 * @param ToolboxVO_Glossary_GlossaryRecord $record
	 * @return array
	 */
	public static function buildRecord($record) {
		$question = self::toolboxVos2expressions($record->term);
		$answers = array();
		foreach ($record->definition as $answer) {
	...
	public static function answer2toolboxVo($answer) {
		$answerVO = new ToolboxVO_Glossary_Definition();
	...
	/**
	 * 
	 * @param ToolboxVO_Glossary_Definition[]
	 * @return array<String, String> $expressions
	 */
