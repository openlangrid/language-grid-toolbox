...
//	$matchingMethod = $_POST['matchingMethod'];
	$matchingAndor = $_POST['matchingAndor'];
...
//
//		$recordsResult = $moduleClient->searchRecordAndor($resourceName, $keyword, $keywordLanguage, $matchingAndor, $searchType
//							, $categories, $sortOrder, $orderBy);
//
//		$records = array();
//		foreach ($recordsResult['contents'] as $record) {
//			$records[] = QaRecordUtil::buildRecord($record, $resourceName);
//		}
//
...
//	$result['contents']['results'] = $count;
	$recordsResult = $moduleClient->searchRecordAndor($resources, $keyword, $keywordLanguage, $matchingAndor, $searchType
							, $categories, $sortOrder, $orderBy);
	$records = array();
	foreach ($recordsResult['contents'] as $record) {
	...
	$result['contents']['results'] = count($recordsResult['contents']);
