...
class QaResourceUtil {
	 ...
	 * @return array
	 */
	public static function buildResource($resource, $records = array(), $categoryIds = array(), $wordSetIds = array(), $boundWordIds = array()) {
		$permissionManager = new QaPermissionManager;
		return array(
			'name' => $resource->name,
			'categoryIds' => $categoryIds,
			'wordSetIds' => $wordSetIds,
			'wordIds' => $boundWordIds,
