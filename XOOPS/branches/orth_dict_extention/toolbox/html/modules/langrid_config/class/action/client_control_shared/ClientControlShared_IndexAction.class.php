...
class ClientControlShared_IndexAction extends IndexAction {

	protected function getResource() {
		$resource = parent::getResource();

		$resource['url'] = array(
			'loadSetting' => './?page=client_control_shared&action=LoadSetting',
			'saveSetting' => './?page=client_control_shared&action=SaveSetting',
			'saveDictionary' => './?page=client_control_shared&action=SaveDictionary',
