...
define('_AD_USER_TIPS2_DATA_UPLOAD', 'ダウンロードしたCSVファイルを使用する。<a href="?action=UserDataDownload?" style="color:#941d55;font-weight:bold;">'._MI_USER_ADMENU_USER_DATA_DOWNLOAD.'</a> 列数の増減はしないでください');
