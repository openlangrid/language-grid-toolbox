...
//Used by Toolbox
define('_AD_USER_LANG_GROUP_LG_USER', 'Language Grid ID');
define('_AD_USER_LANG_GROUP_LG_PASSWD', 'Language Grid password');
define('_AD_USER_LANG_GROUP_LGUSER_DESC', "Language Grid ID");
define('_AD_USER_LANG_GROUP_LGPASSWD_DESC', "Language Grid password");
