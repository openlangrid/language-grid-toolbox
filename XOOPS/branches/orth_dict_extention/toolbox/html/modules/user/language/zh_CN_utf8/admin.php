...
define('_AD_USER_ERROR_UNAME_NO_UNIQUE', "The user ID you entered already exists.");
...
define('_AD_USER_LANG_GROUP_NAME', "Group ID");
...
define('_AD_USER_LANG_GROUP_TYPE_DESC', "Type");
