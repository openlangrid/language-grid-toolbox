...
SQL;
    ...
    // $normalizedLang: 表記統合辞書用ソース言語
	static public function getSQLForSelectAllContentsByDictionaryId($languages, $dictionaryId, $normalizedLang = null) {
		$userDictionaryContentsTable = DBtableName('user_dictionary_contents');
        ...
        $orderClause = "row desc";
        if($normalizedLang) {
           $orderClause = "`".$normalizedLang."`"." asc, ".$orderClause;
        }
		$sql = <<<SQL
			SELECT
				row
...
SQL;
	...
	static public function getSQLForCountAllContents($conditions = "", $groupBy = "") {
...
SQL;
	...
	static public function getSQLForCountAllContentsByDictionaryId($normalizedLang = null) {
