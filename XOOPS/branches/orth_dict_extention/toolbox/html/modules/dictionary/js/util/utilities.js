...
var TMPL = {
	...
	getHeaderCellFixForTableWords: function() {
		return arguments.callee.cash ||
			   (arguments.callee.cash = this.$.down(".table-words .headerCellFix").innerHTML);
	},
    ...
    getCellForTableWordsMulti: function() {
        return arguments.callee.cash ||
               (arguments.callee.cash = this.$.down(".table-words .recordCellMulti").innerHTML);
    },
    
	getListItemForTableWordsMulti: function() {
		return arguments.callee.cash ||
			   (arguments.callee.cash = this.$.down(".table-words .recordCellMulti ul").innerHTML);
	},
	...
	getNewCellForTableWordsMulti: function() {
		return arguments.callee.cash ||
			   (arguments.callee.cash = this.$.down(".table-words .newRecordCellMulti").innerHTML);
	},
    
    getNewListItemForTableWordsMulti: function() {
        return arguments.callee.cash ||
               (arguments.callee.cash = this.$.down(".table-words .newRecordCellMulti ul").innerHTML);
    },
