...
define('SUB_MODULE', 'answer_contents');

require dirname( __FILE__ ).'/../mytrustdirname.php' ; // set $mytrustdirname
require '../helper.php';
require_all_classes($mytrustdirname);

$allow_actions = array( 'image', '_map', '_new', '_reload', 'create_from_pc', 'create_from_url', 'create_from_server', '_delete');
$delegator = get_delegator($allow_actions, "image");
