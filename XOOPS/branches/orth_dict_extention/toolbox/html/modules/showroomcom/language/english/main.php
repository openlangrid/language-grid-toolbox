 ...
 * Common
 */
define('_MD_D3FORUM_BBS_TOP', 'Discussion top');
define('_MD_D3FORUM_BBS', 'Discussion');
...
define('COM_BACK_SELECTED_CONTENT', 'Back to the selected content');
define('COM_ALL_TRANSLATION', '');
define('COM_AUTO', 'Auto');
define('COM_BTN_A_MINUS', 'A-');
define('COM_BTN_A_PLUS', 'A+');
define('COM_BTN_CANCEL', 'Cancel');
define('COM_BTN_NEW_MESSAGE', 'New message');
define('COM_BTN_POST', 'Post');
define('COM_BTN_REPLY', 'Reply');
define('COM_BTN_TRANSLATE', 'Translate');
define('COM_COMMIT', 'Commit');
define('COM_IS_REQUIRED', 'is required');
define('COM_LANGUAGES', 'finished');
define('COM_LNK_CLOSE', 'Close');
define('COM_LNK_DELETE', 'Delete');
define('COM_LNK_EDIT', 'Pre-edit');
define('COM_LNK_EDIT_TRANSLATION', 'Post-edit');
define('COM_LNK_NEW_MESSAGE_ARRIVED', 'You have new message (Click to reload)');
define('COM_LNK_NEW_MESSAGE_RELOADING', 'Reloading new messages');
define('COM_LNK_OPEN', 'Open');
define('COM_MANUAL', 'Manual');
define('COM_MESSAGE', 'Enter your message here.');
define('COM_MESSAGES', '%s message(s)');
define('COM_NEW_MESSAGE', 'New message');
define('COM_NOW_TRANSLATIONING', 'Now translating');
define('COM_NOW_TRANSLATION_REMAIN', 'Now translating: ');
define('COM_REQUIRED', 'is required');
define('COM_SUBMITTED_BY_POST_BUTTON', 'Press "%s" button to submit.');
define('COM_SELECT_ATTACHEMENT_CONTENT', 'Select a content');
define('COM_UNSELECT', 'Clear');
define('COM_BTN_ZOOM', 'Zoom');
define('COM_CONTENTS', '%s content(s)');
define('CON_BTN_NEW_CONTENT', 'New content');
define('COM_BTN_CONTENT_DELETE', 'Delete');
define('COM_BTN_SET_MARKER', 'Set marker');
define('COM_BTN_DEL_MARKER', 'Delete marker');
define('COM_CONTENT_TITLE', 'Content title');
define('COM_SELECT_UPLOAD_FILE', 'File (JPG, PNG, or GIF image file)');
define('COM_BTN_UPLOAD', 'Upload');
define('COM_SET_CONTENT_RELATED', 'Link this content to the message');
define('COM_CONFIRM_DEL_MARKER', 'The marker is not saved. Are you sure to discard the marker?');
define('COM_CONTENT_GUIDELINE', 'Select a content to link to the message from the above pull-down menu.');
define('COM_CONTENT_DEL_REMAIN', 'Are you sure to delete the selected contents?');
define('COM_TRANSLATE_SENTENCE', 'Translation');
define('COM_REPLY_TO_MESSAGE', 'Reply to Message %s');
define('COM_REQUIRE_URL', 'Enter URL of "Link" of Google Maps.');
define('COM_REQUIRE_SELECT_UPLOAD_FILE', 'Select a file to upload.');
define('COM_DELETE_MESSAGE_CONFIRM', 'Are you sure to delete the message?');
define('COM_REPLY_MESSAGES', ' reply messages');
define('COM_REQUIRE_GOOGLE_MAP_URL', 'Enter URL of "Link" of Google Maps.');
define('COM_ENTER_MESSAGE', 'Enter your message.');
define('COM_ENTER_GOOGLEMAP_URL', 'Enter URL of "Link" of Google Maps.');
