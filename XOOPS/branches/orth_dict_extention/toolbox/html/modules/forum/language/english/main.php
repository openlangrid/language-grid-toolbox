...
/* 20130131 add */
define('_MD_D3FORUM_ORGACCESS', 'Organization');
define('_MD_D3FORUM_USERACCESS', 'User');

define('_MD_D3FORUM_ORGNAME', 'Org');
define('_MD_D3FORUM_USERNAME', 'User');

/* 20130131 add */

/* 20130225 add */
define('_MD_D3FORUM_AD_LBL_SOURCELANGUAGE', 'Source');
define('_MD_D3FORUM_AD_LBL_TARGETLANGUAGE', 'Target');
define('_MD_D3FORUM_AD_LBL_DICTIONARYNAME', 'Dictionary');
define('_MD_D3FORUM_AD_LBL_ADDWORDBTN', 'Add&nbsp;Word');
define('_MD_D3FORUM_AD_LBL_ADDWORDOPEN', 'Add&nbsp;Word&nbsp;Panel');
define('_MD_D3FORUM_AD_LBL_SUCCESSTOADDWORD', 'OK');
/* 20130225 add */
