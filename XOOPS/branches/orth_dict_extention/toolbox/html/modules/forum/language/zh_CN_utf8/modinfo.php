...
define($constpref.'_DESC', '该模块为多语言 BBS，能够以多种语言显示发表的帖子。');
//20091126 add
define($constpref.'_MESSAGE_TIME_MANUAL', '手动更新确认间隔（秒）');
define($constpref.'_MESSAGE_TIME_AUTO', '自动更新间隔（秒）');
define($constpref.'_MESSAGE_TIME_MAX', '当前主题阅读用户数据保留时间（秒）');
define($constpref.'_FILE_LIMIT_NUMBER', '附件最大数量');
define($constpref.'_FILE_LIMIT_SIZE', '附件最大容量');
define($constpref.'_DESCRIPTION_AN_HOUR', '输入时间时，请以秒为单位。');
define($constpref.'_DESC_LIMIT_SIZE', '输入容量时，请以KB为单位。');
define($constpref.'_MESSAGE_ACCESSLOG_MAXTIME', '帖子最长保留时间');
//20100106 add
