...
if (isset($_GET['search_result'])) {
	$postsCount = $searchManager->getSearchCount($searchWord, $page, $view,$topicId,$forumId,$categoryId,$tags);
	$posts = $searchManager->searchPosts($searchWord, $page, $view,$topicId,$forumId,$categoryId,$tags);
