...
var ServiceType = {
	...
	TRANSLATOR : 'IMPORTED_TRANSLATION'
};
var Config = {
	Text : {
	...
	Url : {
		ADD_SERVICE : './imported_services.php?page=add-service',
		EDIT_SERVICE : './imported_services.php?page=edit-service',
		LOAD_SERVICES : './imported_services.php?page=load-services',
		LOAD_SUPPORTED_LANGUAGES : './imported_services.php?page=load-supported-languages',
		REMOVE_SERVICE : './imported_services.php?page=remove-service'
	},
	Image : {
