...
var BBSPathPanel = Class.create();

Object.extend(BBSPathPanel.prototype, TranslationPathPanel.prototype);
Object.extend(BBSPathPanel.prototype, {
	_saveSetting: function(save_data) {
		...
		new Ajax.Request('./ajax/save-bbs-setting.php', {
			method: 'post',
			parameters: hash,
			asynchronous:false,
