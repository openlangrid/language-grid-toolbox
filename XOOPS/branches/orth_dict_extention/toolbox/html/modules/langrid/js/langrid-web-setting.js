...
var WebAddPathWorkspace = Class.create();

Object.extend(WebAddPathWorkspace.prototype, AddPathWorkspace.prototype);
Object.extend(WebAddPathWorkspace.prototype, {
	_showPanel: function(setting,listArea) {
		var idx = this.pathPanelArray.length;
		var pathPanel = new WebPathPanel();
	...
	_loadSetting: function() {
		...
		new Ajax.Request('./ajax/load-web-setting.php', {
			method: 'post',
			parameters: hash,
	...
	onDictionarySaveHandler:function(){
		...
		var hash = $H(postObj).toQueryString();
		new Ajax.Request('./ajax/save-web-dict.php', {
			method: 'post',
			parameters: hash,
			controller: controller,
			onSuccess: function(httpObj) {
