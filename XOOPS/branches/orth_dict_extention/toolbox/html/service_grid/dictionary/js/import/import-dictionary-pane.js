...
var ImportDictionaryPane = Class.create({
	...
	createPane: function() {
		...
		cancelButton.value = Const.Message.Cancel;
		cancelButton.type = 'button';
		cancelButton.className = 'import-dictionary-button';
		Event.observe(cancelButton, 'click', this._delegate.cancelButtonClicked.bind(this._delegate));
