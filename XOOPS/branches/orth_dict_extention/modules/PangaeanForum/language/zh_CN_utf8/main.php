 ...
 * Common
 */
define('_MD_D3FORUM_BBS_TOP', 'BBS顶部');
define('_MD_D3FORUM_BBS', 'BBS');
define('_MD_D3FORUM_BBS_SEARCH', 'Search');
define('_MD_D3FORUM_FORUM', '论坛');
define('_MD_D3FORUM_CATEGORY', '类别');
define('_MD_D3FORUM_DESCRIPTION', '说明');
define('_MD_D3FORUM_TOTALFORUMSCOUNT', '论坛');
define('_MD_D3FORUM_LASTPOST', '最新发表');
define('_MD_D3FORUM_TOPICTITLE', '主题名称');
define('_MD_D3FORUM_ON', '发表日期');
define('_MD_D3FORUM_NOW_TRANSLATING', '正在翻译……');
define('_MD_D3FORUM_DOPOST', '发表');
define('_MD_D3FORUM_OK', '确定');
define('_MD_D3FORUM_COMMON_CANCEL', '取消');
define('_MD_D3FORUM_COMMON_CREATE', '新建');
define('_MD_D3FORUM_COMMON_MODIFY', '译文编辑');
define('_MD_D3FORUM_COMMON_REPLY', '回帖');
define('_MD_D3FORUM_COMMON_EDIT', '原文编辑');
define('_MD_D3FORUM_COMMON_DELETE', '删除');
define('_MD_D3FORUM_COMMON_OK', '确定');
define('_MD_D3FORUM_COMMON_ORIGINAL_MESSAGE', '原帖');
define('_MD_D3FORUM_COMMON_ORIGINAL_TITLE', '原始标题');
define('_MD_D3FORUM_POSTASNEWTOPIC', '新建主题');
define('_MD_D3FORUM_POST_MODIFICATION_HISTORIES', '修改记录');
define('_MD_D3FORUM_CANCEL', '取消');
define('_MD_D3FORUM_POSTED_ON', '发表日期 %s');
define('_MD_D3FORUM_MODIFIED_ON', '修改日期 %s');
define('_MD_D3FORUM_EDITED_ON', '编辑日期 %s');
//20090919 add
define('_MD_D3FORUM_COMMON_TRANSLATE', '翻译');
define('_MD_D3FORUM_COMMON_TRANSLATION', '翻译');
define('_MD_D3FORUM_COMMON_BACK_TRANSLATION', '反向翻译');
define('_MD_D3FORUM_COMMON_NOW_TRANSLATING', '正在翻译……');
define('_MI_D3FORUM_HOW_TO_USE_LINK', 'bbs_zh.html');
define('_MD_D3FORUM_PREVIEW_NO_SOURCE', '%s为空。');
define('_MD_D3FORUM_PREVIEW_NO_TRANSLATOIN_RESULT', '{1}（语言： {0}）的翻译结果为空。');
define('_MD_D3FORUM_COMMON_COMMIT', '提交');
define('_MD_D3FORUM_COMMON_POST', '发表');
//20090928 add
define('_MD_D3FORUM_TRANSLATION_LANGRID_ERROR', 'Language Grid 发生错误。');
define('_MD_D3FORUM_MODIFY_ERROR_MESSAGE_IS_EMPTY', '%s 为空。');
//20091013 add
define('_MD_D3FORUM_COMMON_LICENSE_INFORMATION', '许可信息');
define('_MD_D3FORUM_COMMON_SERVICE_NAME', '服务名称');
define('_MD_D3FORUM_COMMON_COPYRIGHT', '版权信息');
//20091113 add
define('_MD_D3FORUM_COMMON_PULL_REFRESH', '刷新');
define('_MD_D3FORUM_COMMON_PULL_AUTO_UPDATE', '自动');
define('_MD_D3FORUM_COMMON_PULL_MANUAL_UPDATE', '手动');
//20091124 add
define('_MD_D3FORUM_COMMON_NEW_POST', '发表');
define('_MD_D3FORUM_CONFIRM_DELETE', '您确定删除所选文件吗？');
define('_MD_D3FORUM_CAPTION_UPLOAD', '附件');
define('_MD_D3FORUM_ATACCHED_FILELIST', '附件列表');
define('_MD_D3FORUM_FILE_NOT_EXIST', '指定文件未找到或其大小为0字节。');
define('_MD_D3FORUM_CAPTION_FILESIZE', '大小（KB）');
define('_MD_D3FORUM_CAPTION_FILENAME', '名称');
define('_MD_D3FORUM_DELETE_FILE', '删除');
define('_MD_D3FORUM_CAPTION_CLOSE', '关闭');
define('_MD_D3FORUM_FILE_OVER_LIMIT_COUNT', '您最多可添加{0}个附件。');
//20091126 add
define('_MD_D3FORUM_FILE_OVER_LIMIT', '附件最大为{0}KB。');
//20091215 add
...
// comment integration
define('_MD_D3FORUM_POSTASCOMMENTTOP', '发表新帖');

// module top (done)
define('_MD_D3FORUM_TOTALTOPICSCOUNT', '主题');
define('_MD_D3FORUM_TOTALPOSTSCOUNT', '帖子');

// postform (done)
define('_MD_D3FORUM_POSTREPLY', '回帖');
define('_MD_D3FORUM_POSTEDIT', '原文编辑');
define('_MD_D3FORUM_POSTDELETE', '删除');
define('_MD_D3FORUM_ERR_NOMESSAGE', '发表的帖子为空。');

// makeforum and forummanager
define('_MD_D3FORUM_TH_FORUMTITLE', '论坛标题');
define('_MD_D3FORUM_TH_FORUMDESC', '论坛说明');

// makecategory and categorymanager
define('_MD_D3FORUM_TH_CATEGORYTITLE', '类别标题');
define('_MD_D3FORUM_TH_CATEGORYDESC', '类别说明');

// add
define('_MD_D3FORUM_POST_TRANSLATION_MODIFY', '译文编辑');
define('_MD_D3FORUM_CREATE_TOPIC', '新建主题');
define('_MD_D3FORUM_POST_TRANSLATE', '翻译');
define('_MD_D3FORUM_POST_TRANSLATION_RESULT', '翻译结果');
define('_MD_D3FORUM_POST_BACK_TRANSLATION_RESULT', '反向翻译结果');
define('_MD_D3FORUM_PREVIEW', '预览');
define('_MD_D3FORUM_MODIFY_MODE', '译文编辑模式');
define('_MD_D3FORUM_ERR_NOT_EXIST_MENU', '没有可以访问的类别或论坛');
define('_MD_D3FORUM_RETURN_PAGE_TOP', '返回顶部');
define('_MD_D3FORUM_RETURN_COMMUNITY_TOP', 'BBS顶部');
define('_MD_D3FORUM_ORIGINAL_TEXT', '原始文本');
define('_MD_D3FORUM_TRANSLATION_RESULT', '翻译');
define('_MD_D3FORUM_BACK_TRANSLATION_RESULT', '反向翻译');
define('_MD_D3FORUM_FROM', '自');
define('_MD_D3FORUM_TO', '至');
define('_MD_D3FORUM_POST_DELETED', '该贴已被删除。');
define('_MD_D3FORUM_CATEGORY_DELETE', '删除该类别');
define('_MD_D3FORUM_FORUM_DELETE', '删除该论坛');

/**
 * Modify Mode
 */
define('_MD_D3FORUM_MODIFY_COMMON_ORIGINAL_INFORMATION', '原始信息');
define('_MD_D3FORUM_MODIFY_COMMON_ORIGINAL_MESSAGE', '原帖');
define('_MD_D3FORUM_MODIFY_COMMON_TRANSLATION', '翻译');
define('_MD_D3FORUM_NO_TRANSLATION', '翻译不可用。');
define('_MD_D3FORUM_POST_ORIGINAL_TEXT', '原帖');
define('_MD_D3FORUM_POST_MODIFY_TEXT', '翻译结果');
define('_MD_D3FORUM_EDIT_TOPIC', '原文编辑');
define('_MD_D3FORUM_MODIFY_TOPIC', '译文编辑');
define('_MD_D3FORUM_DELETE_TOPIC', '删除');
define('_MD_D3FORUM_MESSAGE', '帖子');
define('_MD_D3FORUM_CREATE', '新建');
define('_MD_D3FORUM_EDIT', '原文编辑');
define('_MD_D3FORUM_MODIFY', '译文编辑');
define('_MD_D3FORUM_DELETE', '删除');
define('_MD_D3FORUM_CREATE_A_NEW_CATEGORY', '新建类别');
define('_MD_D3FORUM_CREATE_A_NEW_FORUM', '新建论坛');
define('_MD_D3FORUM_CREATE_A_NEW_TOPIC', '新建主题');
define('_MD_D3FORUM_MODIFY_OK', '确定');
define('_MD_D3FORUM_DELETE_CONFIRM_CATEGORY', '您确定删除该类别吗？');
define('_MD_D3FORUM_DELETE_CONFIRM_FORUM', '您确定删除该论坛吗？');
define('_MD_D3FORUM_DELETE_CONFIRM_TOPIC', '您确定删除该主题吗？');
define('_MD_D3FORUM_DELETE_CONFIRM_MESSAGE', '您确定删除该帖吗？');
define('_MD_D3FORUM_CATEGORY_MODIFY_TITLE', '译文编辑');
define('_MD_D3FORUM_REPLY', '回帖');
...
define('_MD_D3FORUM_JUMPBOX_BUTTON', 'Post');
