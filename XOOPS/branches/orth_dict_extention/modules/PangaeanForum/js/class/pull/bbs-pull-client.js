...
//		this.AUTO_INTERVAL_TIME = 10;
	...
	createMessageHtml : function(post, isNew) {
		...
		if (post.files && post.files.length > 0) {
			fileIcon = '<a id="DownloadFileButton-' + post.id + '" class="DownloadFileButton" href="javascript:void(0)" onclick="return false;"><img alt="File List" src="./images/attach_icon.gif"  style="vertical-align:middle;"></a>';
		}
...
BBSPullClient.prototype.Templates = {
	...
	HEADER : '<td class="list_line01" style="padding:1px 0px; width:65%;">'
		+ '<img width="30" src="#{avatar}" style="vertical-align:middle;">'
