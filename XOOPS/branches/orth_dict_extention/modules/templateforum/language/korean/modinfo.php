...
define($constpref.'_DESC', '다음은 메시지를 여러 언어로 표시할 수 있는 다국 BBS의 모듈입니다.');
//20091126 add
define($constpref.'_MESSAGE_TIME_MANUAL', '수동 업데이트에서 확인하는 업데이트 간격(초)');
define($constpref.'_MESSAGE_TIME_AUTO', '자동 업데이트의 간격(초)');
define($constpref.'_MESSAGE_TIME_MAX', '현재 항목 판독기의 데이터 보존 기간(초)');
define($constpref.'_FILE_LIMIT_NUMBER', '첨부 파일의 최대 수');
define($constpref.'_FILE_LIMIT_SIZE', '첨부 파일의 최대 크기');
define($constpref.'_DESCRIPTION_AN_HOUR', '시간을 초단위로 입력하십시오.');
define($constpref.'_DESC_LIMIT_SIZE', '크기를 KB 단위로 입력하십시오.');
define($constpref.'_MESSAGE_ACCESSLOG_MAXTIME', '메시지의 최대 보존 시간');
//20100106 add
