...
$filesharing_assign_globals = array(
	...
	'lang_top_title' =>  @str_replace("{0}",$xoopsModuleConfig['filesharing_perpage'],_MD_ALBM_NEWFILES ),
	...
	'thumbsize' => $filesharing_thumbsize ,
	'colsoftableview' => $filesharing_colsoftableview ,
