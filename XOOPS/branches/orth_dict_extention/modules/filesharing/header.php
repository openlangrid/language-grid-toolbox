...
$xoops_module_header .= '<script type="text/javascript" src="'.XOOPS_URL.'/modules/'.$mydirname.'/js/jquery.js"></script>'."\n";
...
$xoops_module_header .= '<script type="text/javascript">$.noConflict();</script>'."\n";
