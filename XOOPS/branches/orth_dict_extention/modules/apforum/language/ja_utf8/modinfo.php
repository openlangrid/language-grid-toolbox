...
if( defined( 'FOR_XOOPS_LANG_CHECKER' ) || ! defined( $constpref.'_LOADED' ) ) {
	...
	define($constpref.'_DESC', 'メッセージが多言語で表示できる掲示板のモジュールです。');
	//20091126 add
	...
	//20100106 add
	define($constpref.'_MESSAGE_FILE_CAT_ID', '添付ファイル投稿先ファイル共有フォルダID');
	//2010916 add
	define($constpref.'_NOTIFY_LIMIT', '投稿通知メールに表示するメッセージ最大文字数');
	//20111209 add
	define($constpref.'_NOT_CHECK_GROUP','アクセス権限に表示しないグループ');
