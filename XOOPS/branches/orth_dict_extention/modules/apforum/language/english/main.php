...
define('_MI_D3FORUM_HOW_TO_USE_LINK', 'bbs_en.html');
...
//20091113 add
define('_MD_D3FORUM_COMMON_PULL_REFRESH', 'Refresh');
define('_MD_D3FORUM_COMMON_PULL_AUTO_UPDATE', 'Auto');
define('_MD_D3FORUM_COMMON_PULL_MANUAL_UPDATE', 'Manual');
//20091124 add
define('_MD_D3FORUM_COMMON_NEW_POST', 'Post');
define('_MD_D3FORUM_CONFIRM_DELETE', 'Are you sure to delete the selected file?');
define('_MD_D3FORUM_CAPTION_UPLOAD', 'Attached file');
define('_MD_D3FORUM_ATACCHED_FILELIST', 'Attached file list');
define('_MD_D3FORUM_FILE_NOT_EXIST', 'The specified file is not found or the size of the file is 0 byte.The specified file is not found or the the file size is 0 byte.');
define('_MD_D3FORUM_CAPTION_FILESIZE', 'Size (KB)');
define('_MD_D3FORUM_CAPTION_FILENAME', 'Name');
define('_MD_D3FORUM_DELETE_FILE', 'Delete');
define('_MD_D3FORUM_CAPTION_CLOSE', 'Close');
define('_MD_D3FORUM_FILE_OVER_LIMIT_COUNT', 'You can attach up to {0} files.');
//20091126 add
define('_MD_D3FORUM_FILE_OVER_LIMIT', 'The maximum size of an attached file is {0} KB.');
//20091215 add
...
// 20110907 add
define('_MD_D3FORUM_TH_AUTH', 'Access authority');
define('_MD_D3FORUM_PREVIEW_NO_CHECK_AUTH', "Access authority : A belonging group isn\'t chosen.");
define('_MD_D3FORUM_PREVIEW_NO_CHECK_CHILD_AUTH', "Access authority :An access right of a child element isn\'t permitted.");
define('_MD_D3FORUM_PREVIEW_NO_CHECK_PARENT_AUTH', "Access authority :The access right which isn\'t permitted by containing element is chosen.");
define('_MD_D3FORUM_PREVIEW_CHECKBOX_NO_CHECK', "Access authority :Please select at least one group");
define('_MD_D3FORUM_PREVIEW_INPUT_ERROR','Input Error');
define('_MD_D3FORUM_PREVIEW_ALL_GROUPS','All groups');
define('_MD_D3FORUM_PREVIEW_CAN_NOT_ALL_GROUPS',"Access authority :AllGroups can\'t be chosen.");
// add
...
define('_MD_D3FORUM_RETURN_COMMUNITY_TOP', 'BBS top');
...
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_3', 'For each post(reply only)');
define('_MD_D3FORUM_POSTED_NOTICE_POP_INTERVAL_OP_4', 'Once a day(reply only)');
...
define('_MD_D3FORUM_SEARCH_DATE', 'Date');
define('_MD_D3FORUM_RECENTLY_POST_SEARCH', 'Recently Post');
define('_MD_D3FORUM_RECENTLY_POST_SEARCH_OPTION', 'Date');

/* ProtoCalendar */
define('_MD_D3FORUM_PROTOCALENDAR_HOUR_MINUTE_ERROR', 'The time is not valid.');
define('_MD_D3FORUM_PROTOCALENDAR_NO_DATE_ERROR', 'No day has been selected.');
define('_MD_D3FORUM_PROTOCALENDAR_DEFAULT_FORMAT', 'yyyy/mm/dd');
define('_MD_D3FORUM_PHP_DATE_DEFAULT_FORMAT', 'Y/m/d');
define('_MD_D3FORUM_PROTOCALENDAR_LABEL_FORMAT', 'yyyy/mm/dd ddd');
define('_MD_D3FORUM_PROTOCALENDAR_OK_LABEL', 'OK');
define('_MD_D3FORUM_PROTOCALENDAR_JAN', 'Jan');
define('_MD_D3FORUM_PROTOCALENDAR_FEB', 'Feb');
define('_MD_D3FORUM_PROTOCALENDAR_MAR', 'Mar');
define('_MD_D3FORUM_PROTOCALENDAR_APR', 'Apr');
define('_MD_D3FORUM_PROTOCALENDAR_MAY', 'May');
define('_MD_D3FORUM_PROTOCALENDAR_JUN', 'Jun');
define('_MD_D3FORUM_PROTOCALENDAR_JUL', 'Jul');
define('_MD_D3FORUM_PROTOCALENDAR_AUG', 'Aug');
define('_MD_D3FORUM_PROTOCALENDAR_SEP', 'Sep');
define('_MD_D3FORUM_PROTOCALENDAR_OCT', 'Oct');
define('_MD_D3FORUM_PROTOCALENDAR_NOV', 'Nov');
define('_MD_D3FORUM_PROTOCALENDAR_DEC', 'Dec');
define('_MD_D3FORUM_PROTOCALENDAR_SUN', 'Sun');
define('_MD_D3FORUM_PROTOCALENDAR_MON', 'Mon');
define('_MD_D3FORUM_PROTOCALENDAR_TUE', 'Tue');
define('_MD_D3FORUM_PROTOCALENDAR_WED', 'Wed');
define('_MD_D3FORUM_PROTOCALENDAR_THU', 'Thu');
define('_MD_D3FORUM_PROTOCALENDAR_FRI', 'Fri');
define('_MD_D3FORUM_PROTOCALENDAR_SAT', 'Sat');
