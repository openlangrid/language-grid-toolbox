...
define('_MD_ALBM_HOW_TO_USE_LINK', 'apfilesharing_ja.html');
...
// Use is Dialog
define('_MI_apfilesharingDIALOG_DIALOG_TITLE', 'ファイルを選択');
define('_MI_apfilesharingDIALOG_UPLOAD_BUTTON', 'ファイルをアップロード');
define('_MI_apfilesharingDIALOG_TABLE_COL_SELECT', '');
define('_MI_apfilesharingDIALOG_TABLE_COL_NAME', 'ファイル名');
define('_MI_apfilesharingDIALOG_TABLE_COL_DESC', '説明');
define('_MI_apfilesharingDIALOG_TABLE_COL_READ', '読み込み');
define('_MI_apfilesharingDIALOG_TABLE_COL_EDIT', '書き込み');
define('_MI_apfilesharingDIALOG_TABLE_COL_UPDATER', '作成者');
define('_MI_apfilesharingDIALOG_TABLE_COL_UPDATE', '最終保存日');
define('_MI_apfilesharingDIALOG_OK_BUTTON', 'OK');
define('_MI_apfilesharingDIALOG_CANCEL_BUTTON', 'キャンセル');
define('_MI_apfilesharingDIALOG_SAVE_DIALOG_TITLE', 'ファイルを保存');
define('_MI_apfilesharingDIALOG_SAVE_FILE_NAME', 'ファイル名');
define('_MI_apfilesharingDIALOG_SAVE_FILE_DESC', 'ファイルの説明');
define('_MI_apfilesharingDIALOG_SAVE_PERM', '権限');
define('_MI_apfilesharingDIALOG_SAVE_READ_PERM', '閲覧を許可');
define('_MI_apfilesharingDIALOG_SAVE_EDIT_PERM', '編集を許可');
define('_MI_apfilesharingDIALOG_SAVE_PERM_OPT_PUBLIC', '全ユーザ');
define('_MI_apfilesharingDIALOG_SAVE_PERM_OPT_USER', '現在のユーザのみ');
define('_MI_apfilesharingDIALOG_SAVE_OK_BUTTON', '保存');
define('_MI_apfilesharingDIALOG_ROOT_FOLDER_LABEL', 'トップ');
define('_MI_apfilesharingDIALOG_ERROR_PERMISSION_NO_EDIT', 'このフォルダにファイルを保存する権限がありません。');
...
//permission----------------------------------
define( 'MD_apfilesharing_ALL_USER','全ユーザ');
define( 'MD_apfilesharing_UP_USER','ファイルの所有者');

define( 'MD_FSA_SUBMIT_DIALOG_RP','閲覧の許可が設定されていません。ファイルの所有者のみ閲覧できます。');
define( 'MD_FSA_SUBMIT_DIALOG_EP','編集の許可が設定されていません。ファイルの所有者のみ編集できます。');
define( 'MD_FSA_SUBMIT_DIALOG','送信してもよろしいですか？');

define('MD_FSA_ERROR_PERMISSION', 'アクセス権限が有効ではありません。');

define('MD_FSA_NOT_PARENT_FOLDER_PERMISSION_FOLDER', '親フォルダでこのフォルダの権限が許可されていない為、設定できません。');
define('MD_FSA_NOT_PARENT_FOLDER_PERMISSION_FILE', '親フォルダでこのファイルの権限が許可されていない為、設定できません。');
define('MD_FSA_NOT_CHILDREN_FOLDER_PERMISSION', '子要素の権限が許可されていない為、設定できません。');
}
