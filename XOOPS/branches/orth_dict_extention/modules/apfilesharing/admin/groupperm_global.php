...
//		GPERM_DELETABLE => _MD_ALBM_GPERM_G_DELETABLE ,
	...
	$form = new MyXoopsGroupPermForm( '' , $xoopsModule->mid() , 'apfilesharing_global' , _AM_MD_ALBM_GROUPPERM_GLOBALDESC ) ;
...
if( ! empty( $_POST['submit'] ) ) {
	...
	redirect_header( XOOPS_URL."/modules/".$xoopsModule->dirname()."/admin/groupperm_global.php" , 1 , _AM_MD_ALBM_GPERMUPDATED );
}
...
echo "<h4 style='text-align:left;'>"._AM_MD_ALBM_GROUPPERM_GLOBAL."</h4>\n" ;
list_groups() ;
xoops_cp_footer() ;
