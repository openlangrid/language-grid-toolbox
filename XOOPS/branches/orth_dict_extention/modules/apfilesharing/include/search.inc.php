...
eval( '
function apfilesharing_search( $keywords , $andor , $limit , $offset , $userid )
{
	return apfilesharing_search_base( "'.$mydirname.'" , $keywords , $andor , $limit , $offset , $userid ) ;
}
' ) ;

if( ! function_exists( 'apfilesharing_search_base' ) ) {

function apfilesharing_search_base( $mydirname , $keywords , $andor , $limit , $offset , $userid )
{
	global $xoopsDB ;
	...
	$ret = array() ;
	$context = '' ;
	include_once XOOPS_ROOT_PATH."/modules/$mydirname/class/apfilesharing.textsanitizer.php" ;
