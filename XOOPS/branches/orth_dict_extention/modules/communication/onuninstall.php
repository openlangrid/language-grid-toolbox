...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return communication_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'communication_onuninstall_base' ) ) {

function communication_onuninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'communication_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
...
function communication_message_append_onuninstall( &$module_obj , &$log )
{
